...
class Product_category_model extends CI_Model {
    ...
    var $column_order = array('name','description','tax_name'); //set column field database for datatable orderable
    var $column_search = array('name','description','tax_name'); //set column field database for datatable searchable 
