...
class Department_model extends CI_model {
  ...
  var $order = array('department_id' => 'desc'); // default order 
  ...
  // public function delete_record($department_id,$soft_delete = TRUE)
  // {
  ...
  public function get_single_record($department_id)
  {
    $this->db->select('*');
    $this->db->from('hr_departments');
    $this->db->where('department_id',$department_id);
  ...
  public function check_employee_exists($department_id) 
  {
    $this->db->where('department_id', $department_id);
  ...
  //   $dateformat = csession('department_date_format');
  ...
  //   return (csession('department_prefix').csession('seperator').$date.csession('seperator').(csession('department_sequence')+sizeof($data)+1));
  // }
    ...
    public function get_lastest_sequence_number()
    {
        ...
        $dateformat = csession('department_date_format');  // This is expected to be a valid date format string
        ...
        $sequenceNumber = csession('department_sequence') + count($data) + 1;
        $formattedSequence = csession('department_prefix') . csession('seperator') . $date . csession('seperator') . $sequenceNumber;
