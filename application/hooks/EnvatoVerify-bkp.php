...
class EnvatoVerify {
    ...
    private function shouldIncludeJs() {
        ...
        $filePath = FCPATH . 'assets/js/v_data.json';
    ...
    private function isValidPurchaseCode($purchaseCode,$jsonCompanyName, $dbCompanyName, $hash) {
		...
		private function verifyPurchaseCode($purchaseCode, $jsonCompanyName, $dbCompanyName, $hash) {
		    ...
		    $excludedHashes = [
		        '2f2347ae5df530935a7d206839e69dcf9d29ef76e314a495302b2d1bb1c178ce', // hash for vaksys.com
		        '7c8c5ae82719f91e9e372d3b5e2df0b70bdf6b7ef716e4cfa15e3a0346cbdf4f', // hash for zivaansolutions.com
		        'd1d6d0c2a9f97b10d5a582a6d7c3d5b7c1adbf5ed5e96d4c59f707ad1b1ed524', // hash for eorderdaily.com
		        '1a755f4cbaf0bb78faaff1c9c0a342ed5d9fdd0f6dbb3b0283ff1ddfae3de497'  // hash for zpsas.in
		    ];
