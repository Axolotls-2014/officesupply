...
<form role="form" method="post" name="copyemailTemplateForm" id="copyemailTemplateForm">
  <div class="modal-header text-left">
    <h4 class="modal-title">
      <?php echo $this->lang->line('email_template_copy');?>
    </h4>
            ...
            <select class="form-control field_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('email_template_module')?>" id="module" name="module">
                ...
                foreach ($module_array as $module) {
                    ...
                    if (!$is_assigned || $is_selected) {
                        ?>
                        <option value="<?=$module?>" <?=($is_selected) ? 'selected' : ''?>><?=clean_e_val($module)?></option>
                        <?php 
                    }
                }
                ?>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" name="submit" id="copyEmailTemplateSubmit" class="btn btn-primary"><?=$this->lang->line('submit')?></button>
