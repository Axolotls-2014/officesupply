  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item "><a href="<?=base_url('product')?>"><?=$this->lang->line('header_product')?></a></li>
                <li class="breadcrumb-item active"><?=$this->lang->line('product_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addProductForm" id="addProductForm" method="POST">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('product_add')?></h3>
                </div>
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="description" value="<?=set_value('description') ?>" class="form-control form-control-sm" id="description" placeholder="<?=$this->lang->line('product_description')?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="price" value="0" class="form-control form-control-sm" id="price" placeholder="<?=$this->lang->line('product_price')?>" step="0.1">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="cost" value="0" class="form-control form-control-sm" id="cost" placeholder="<?=$this->lang->line('product_cost')?>" step="0.1">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="markup" value="<?=set_value('markup') ?>" class="form-control form-control-sm" id="markup" placeholder="<?=$this->lang->line('product_markup')?>" step="0.1">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="alert_quantity" value="<?=set_value('alert_quantity',0.0) ?>" class="form-control form-control-sm field_validation" id="alert_quantity" placeholder="<?=$this->lang->line('product_alert_quantity')?>" step="0.1">
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="submit" id="productSubmit" class="btn btn-info"><?=$this->lang->line('product_save')?></button>
...
<script type="text/javascript">
  ...
  $(document).ready(function(e){
    ...
    $("form#addProductForm  .field_validation").on("blur change keyup",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
