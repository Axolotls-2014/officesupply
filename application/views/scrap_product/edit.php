              ...
              <div class="card card-info">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="price" value="<?=($product != null) ? $product->p_price : '0' ?>" class="form-control form-control-sm" id="price" placeholder="<?=$this->lang->line('product_price')?>" step="0.1">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="cost" value="<?=($product != null) ? $product->p_cost : '0' ?>" class="form-control form-control-sm" id="cost" placeholder="<?=$this->lang->line('product_cost')?>" step="0.1">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
