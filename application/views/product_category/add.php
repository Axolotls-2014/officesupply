  ...
  <div class="wrapper">
    <div class="content-wrapper">
      <section class="content-header">
          <div class="row mb-2">
            ...
            <li class="breadcrumb-item "><a href="https://ossdemo.tastytap.in/product_core"><?=$this->lang->line('header_inventory')?></a></li>
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('product_category_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addproductCategoryForm" id="addproductCategoryForm" method="post" action="">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('product_category_add')?></h3>
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="name"  value="<?=set_value('name') ?>" class="form-control form-control-sm field_validation" id="name" placeholder="<?=$this->lang->line('product_category_name')?>"><?=form_error('name', '<div class="text-danger">', '</div>');?>
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="submit" id="productCategorySubmit" class="btn btn-info"><?=$this->lang->line('product_category_save')?></button>
...
<script type="text/javascript">
  ...
  $(document).ready(function(e){
    ...
    $('form#addproductCategoryForm').submit(function(e){
      // e.preventDefault();
      ...
      if(isError == true)
      {
        $('#productCategorySubmit').text('<?=$this->lang->line("product_category_save")?>').removeAttr('disabled');
        return false;
      }  
      else 
      {
    ...
    $("form#addproductCategoryForm  .field_validation").on("blur keyup",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
