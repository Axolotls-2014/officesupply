      ...
      <div class="row">
        <div class="col-md-12" style="opacity: 0.7; border-radius: 5px; background-color: #F8E4A4; font-size: 16px;">
          <div class="m-4">
            ...
            <!-- <a href="<?=base_url('assets/sample_files/sample_pack_slip_items.csv')?>" target="_blank" class="btn btn-info" style="float:right">Click here to Download</a>   -->

            <a href="<?=base_url('purchase_order/export_products')?>" target="_blank" class="btn btn-success" style="float:right">Download Existing products</a>  
            <a href="<?=base_url('assets/sample_files/sample_purchase_product.csv')?>" target="_blank" class="btn btn-info mr-2" style="float:right">Download sample file</a>  
