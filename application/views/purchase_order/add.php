  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('purchase_order_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addPurchaseOrderForm" id="addPurchaseOrderForm" method="POST" action="<?=base_url('purchase_order/add')?>">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('purchase_order_add')?></h3>
                ...
                <div class="card-body">
                  <div class="col-sm-12">
                    <div class="row">
                      ...
                      <!--    <label><?=$this->lang->line('purchase_order_reference_no')?></label>-->
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="purchase_order_date" name="purchase_order_date" value="<?=date('d-m-Y');?>" autocomplete="off">
                        ...
                        <!-- <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <?php } else { ?>
                                        <select class="form-control form-control-sm select2bs4 field_validation" name="warehouse_id" id="warehouse_id" width="100%" placeholder="<?=$this->lang->line('purchase_order_warehouse')?>">
                                        ...
                                        <?php if ($this->permission_model->has_permission('add_warehouse')): ?>
                                            <span class="input-group-append">
                                                <button type="button" class="btn btn-info btn-flat add_warehouse_modal" data-toggle="modal" data-target="#add_warehouse_modal" data-tt="tooltip" accesskey="c">
    ...
    <div class="form-group">
        ...
        <span id="err_warehouse_id" class="error invalid-feedback"><?=form_error('warehouse_id');?></span>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          <label for="warehouse">
                            <?=$this->lang->line('purchase_order_supplier')?>
                            <span class="text-danger">*</span>
                          </label>
                          <div class="input-group input-group-sm">
                            <select class="form-control form-control-sm select2bs4 field_validation" name="supplier_id" id="supplier_id" width="100%" class="add-row" placeholder="<?=$this->lang->line('purchase_order_supplier')?>">
                              <option value=""><?=$this->lang->line('select')?></option>
                              <?php
  ...
  <div class="col-sm-3">
    <div class="form-group">
      ...
      <select class="form-control select2bs4" id="due_days" name="due_days">
       ...
       <?php foreach ($due_days_options as $pt): ?>
         <option value="<?= $pt->due_day ?>"
        data-terms="<?= htmlspecialchars($pt->terms_and_condition) ?>">
    <?= $pt->due_day ?> Days
</option>
        <?php endforeach; ?>
      </select>
  ...
  <div class="col-sm-5">
    <div class="form-group">
      ...
      <textarea id="payment_terms"
          ...
          class="form-control"
          rows="1"
          style="resize:none;height:35px;"></textarea>
    </div>
  </div>
                        ...
                        <div class="well">
                          <div class="row">
                            ...
                            <div class="col-sm-12 search">
                              ...
                              <input id="search_product" class="form-control search_product"  type="text" name="search_product"  placeholder="<?=$this->lang->line('purchase_order_item_search')?>">
                            </div>
                            <div class="col-sm-8">
...
<table class="table items table-striped table-bordered table-condensed table-hover product_table" 
    ...
    <thead>
        <tr>
            ...
            <th class="span2" width="8%"><?=$this->lang->line('purchase_order_qty')?></th>
            <th class="span2" width="10%"><?=$this->lang->line('purchase_order_cost')?></th>
            ...
            <th class="span2 d-none" width="100px"><?=$this->lang->line('purchase_order_price')?></th>
            <th class="span2 d-none" width="100px"><?=$this->lang->line('purchase_order_discount')?></th>
            <th class="span2" width="8%"><?=$this->lang->line('purchase_order_uom')?></th>
            <th class="span2" width="10%"><?=$this->lang->line('purchase_order_taxable_value')?></th>
            <th class="span2" width="12%"><?=$this->lang->line('purchase_order_tax')?></th>
            <th class="span2 d-none" width="100px"><?=$this->lang->line('purchase_order_inclusive')?></th>
            <th class="span2" width="8%"><?=$this->lang->line('purchase_order_total')?></th>
        </tr>
    </thead>
       ...
       id="product_data">
          <thead>
            <tr>
              ...
              <th width="8%">HSN</th>
              <th width="8%">Purchase Qty</th>
              <th width="8%"><?=$this->lang->line('purchase_order_uom')?></th>
              <th width="10%">Product MRP</th>
              <th width="10%">Price/Unit</th>
              <th width="10%"><?=$this->lang->line('purchase_order_discount')?></th>
              <th width="10%"><?=$this->lang->line('purchase_order_taxable_value')?></th>
              <th width="12%"><?=$this->lang->line('purchase_order_tax')?></th>
          ...
          <td align='right' width="34%">
            ...
            <input type="hidden" name="total" id="t" value="0">
                          ...
                          <div class="controls">
                            <div class="tabbable">
                              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link active" href="#external_note" data-toggle="pill"><?php echo $this->lang->line('purchase_order_external_note'); ?></a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="#internal_note" data-toggle="pill"><?php echo $this->lang->line('purchase_order_internal_note'); ?></a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="#terms_and_condition" data-toggle="pill"><?php echo $this->lang->line('purchase_order_terms_and_condition'); ?></a>
                                </li>
                              </ul>                           
                              <br>
                              <div class="tab-content">
                                <div class="tab-pane active" id="external_note">
                                  <textarea class="col-sm-12 form-control" name="external_note" rows="4" placeholder="<?php echo $this->lang->line('purchase_order_external_note'); ?>"></textarea>
                                </div>
                                <div class="tab-pane" id="internal_note">
                                  <textarea class="col-sm-12 form-control" name="internal_note" rows="4" placeholder="<?php echo $this->lang->line('purchase_order_internal_note'); ?>"></textarea>
                                </div>
                                <div class="tab-pane" id="terms_and_condition">
                                  <textarea class="col-sm-12 form-control" name="terms_and_condition" rows="4" placeholder="<?php echo $this->lang->line('purchase_order_terms_and_condition');?>"><?=str_replace("<br />","",$company_setting->terms_and_condition)?></textarea>
                                </div>
                              </div>
                            </div>   
                          </div>
                ...
                <div class="card-footer">
                  <input type="hidden" name="purchase_order_items" id="purchase_order_items" value="">
          ...
          success: function(response){
            ...
            $('#add_warehouse_modal').modal('hide');
              $('form#addWarehouseForm #addWarehouseSubmit').text('<?=$this->lang->line("submit")?>').removeAttr('disabled');
               if($('form#addPurchaseOrderForm #warehouse_id').length)
              {
                $('form#addPurchaseOrderForm #warehouse_id').html('');
                $('form#addPurchaseOrderForm #warehouse_id').append('<option value="">Select</option>');
                
                for(i=0;i<response['warehouses'].length;i++)
                { 
                  $('form#addPurchaseOrderForm #warehouse_id').append('<option value="' + response['warehouses'][i].id + '">' + response['warehouses'][i].name +'</option>');
                }

                $('form#addPurchaseOrderForm #warehouse_id').val(response['id']).attr("selected","selected");
   ...
   $(document).on('submit','#addProductForm',function(e){
    ...
    $('#supplier_id').change(function(e){
      ...
      $(document).on('click', ".import_product_modal" ,function(event){
        ...
        {
          $.ajax({
            url: "<?php echo base_url('purchase_order/import_product')?>",
            type: "GET",
            dataType: "JSON",
            success: function(data){
          ...
          Swal.fire({
            title: "Message",
            text: "Please select supplier and warehouse to import product",
            // type: "warning",
            buttonsStyling: !1,
            confirmButtonText: "Ok, got it!",
            timer: 5000,
      ...
      /*$(document).on('submit', 'form#importproductForm', function (event) {
        ...
        var supplierId = $('form#addPurchaseOrderForm #supplier_id').val();
        var warehouseId = $('form#addPurchaseOrderForm #warehouse_id').val();
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                show_message('failure-header',error);
                // show_message('failure-header','There is issue while parsing response.')
                // Reset the submit button
                $('form#importproductForm #importproductSubmit').text('<?=$this->lang->line("submit")?>').removeAttr('disabled');
            }
        });
...
$(document).on('submit', 'form#importproductForm', function (event) {
    ...
    $('form#importproductForm #importproductSubmit').text('Please wait...').attr('disabled', 'disabled');
    ...
    if (csvfileInput.files.length === 0) {
        ...
        $('form#importproductForm #importproductSubmit').text('Submit').removeAttr('disabled');
        return false;
    }
    ...
    if(!supplierId || !warehouseId) {
        Swal.fire({
            title: "Message",
            text: "Please select supplier and warehouse first",
            buttonsStyling: !1,
            confirmButtonText: "Ok, got it!",
            customClass: {
                confirmButton: "btn btn-primary"
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            $('form#importproductForm #importproductSubmit').text('Submit').removeAttr('disabled');
            $('form#importproductForm #csvfile').val('');
        ...
        error: function (xhr, status, error) {
            ...
            Swal.fire({
                title: "Error",
                text: "An error occurred while uploading the CSV file. Please check the console for details.",
                buttonsStyling: !1,
                confirmButtonText: "Ok",
                customClass: {
                    confirmButton: "btn btn-primary"
  ...
  /* function add_row(product,discounts) {
        ...
        if (quantity === null || quantity === undefined || quantity == '') {
          var input_quantity  =  '<input type="number" class="form-control" name="quantity" value="1" step="0.01" min="0.01">';
        } else {
          var input_quantity  =  '<input type="number" class="form-control" name="quantity" value="'+quantity+'" step="0.01" min="0.01">';
        }
...
function add_row(product, discounts) {
    ...
    select_discount += '<input type="hidden" name="discount_amount_hidden" value="0">'; // ADD THIS HIDDEN INPUT
...
function reindexSerialNumbers() {
    ...
    row.find('input[name="discount_amount_hidden"]').val(final_discount_amount.toFixed(2));
...
/* fright charges not added (04-05-2026)   function calculateGrandTotal() {
    var total_taxable_value = 0.0;
    var total_tax = 0.0;
    var total = 0.0;
    var total_discount = 0.0;
...
/*function calculateGrandTotal() {
    ...
    $("#product_table_body tr").each(function() {
        ...
        if(tr.hasClass('freight-row')) {
            ...
            var freightTotal = parseFloat(freightTotalText) || 0;
            total_taxable_value += freightTotal;
            total += freightTotal;
        } else {
            total_taxable_value += parseFloat(tr.find('span[name^="taxable_value"]').text()) || 0;
            total_tax += (parseFloat(tr.find('span[name^="i_tax"]').text()) || 0) +
...
function calculateGrandTotal() {
    ...
    $("#product_table_body tr").each(function() {
        ...
        if(tr.hasClass('freight-row')) {
            ...
            // Regular product rows - add to all totals
            total_taxable_value += parseFloat(tr.find('span[name^="taxable_value"]').text()) || 0;
            total_tax += (parseFloat(tr.find('span[name^="i_tax"]').text()) || 0) +
                        (parseFloat(tr.find('span[name^="c_tax"]').text()) || 0) +
                        (parseFloat(tr.find('span[name^="s_tax"]').text()) || 0);
    ...
    // Update totals display
    // Total Taxable Value should NOT include freight charges
    $('#total_taxable_value').text(total_taxable_value.toFixed(2));
    $('#t_taxable_value').val(total_taxable_value.toFixed(2));
    
    // Total Tax remains the same (freight has no tax in your case)
    $('#total_tax').text(total_tax.toFixed(2));
    $('#t_tax').val(total_tax.toFixed(2));
    
    // Total includes products + tax + freight
    $('#total').text(total.toFixed(2));
    $('#t').val(total.toFixed(2));
}
...
$('table.product_table').on('click', "span.delete_item", function(e){
    ...
    calculateGrandTotal();
     ...
     /* $('#addPurchaseOrderForm').submit(function(e){
        ...
        var isError = false;
        $('#purchaseOrderSubmit').text('<?=$this->lang->line("please_wait")?>').attr('disabled','disabled');

        $('form#addPurchaseOrderForm .field_validation').each(function() {
            var id    = $(this).attr('id');
            var value = $(this).val();
            var field = $(this).attr('placeholder');

            if(value==null || value==""){
              $("form#addPurchaseOrderForm #err_"+id).text(field+ " field is required.").fadeIn('slow');
              $('form#addPurchaseOrderForm #'+id).addClass('is-invalid');
              isError = true;
            }
            else
            {
              $("form#addPurchaseOrderForm #err_"+id).text("").fadeOut('slow');
              $('form#addPurchaseOrderForm #'+id).removeClass('is-invalid');
              $('form#addPurchaseOrderForm #'+id).addClass('is-valid');
            }
        });
        ...
        $("#product_table_body").find('tr').each(function () {
            ...
            productData['product_remark']   = productData['product_remark'] = tr.find('textarea[name^="product_remark"]').val();
        ...
        {
          $('#purchase_order_items').val(productDataArray.join('|'));
        }
        else
        {
          isError = true;
    ...
    // Set freight fields directly
    var freight_amount = 0;
    var freight_taxable_value = 0;
    var freight_sub_total = 0;
    var freight_tax_rate = 0;
    var freight_tax_amount = 0;

    // Check if freight row exists and get values
    $(".freight-row").each(function() {
        freight_amount = parseFloat($(this).find('.freight-price').val()) || 0;
        freight_taxable_value = parseFloat($(this).find('.freight-taxable-value').text()) || 0;
        freight_sub_total = parseFloat($(this).find('.freight-total-price').text()) || freight_amount;
    });

    // Set the freight fields as hidden inputs
    if ($('#freight_amount').length === 0) {
        $('<input>').attr({type: 'hidden', id: 'freight_amount', name: 'freight_amount'}).appendTo('#addPurchaseOrderForm');
        $('<input>').attr({type: 'hidden', id: 'freight_taxable_value', name: 'freight_taxable_value'}).appendTo('#addPurchaseOrderForm');
        $('<input>').attr({type: 'hidden', id: 'freight_sub_total', name: 'freight_sub_total'}).appendTo('#addPurchaseOrderForm');
        $('<input>').attr({type: 'hidden', id: 'freight_tax_rate', name: 'freight_tax_rate'}).appendTo('#addPurchaseOrderForm');
        $('<input>').attr({type: 'hidden', id: 'freight_tax_amount', name: 'freight_tax_amount'}).appendTo('#addPurchaseOrderForm');
    }
    
    $('#freight_amount').val(freight_amount.toFixed(2));
    $('#freight_taxable_value').val(freight_taxable_value.toFixed(2));
    $('#freight_sub_total').val(freight_sub_total.toFixed(2));
    $('#freight_tax_rate').val(freight_tax_rate.toFixed(2));
    $('#freight_tax_amount').val(freight_tax_amount.toFixed(2));
    ...
    $("#product_table_body").find('tr').each(function () {
        ...
        // Skip freight row - we already handled it separately
        ...
        // FIXED: Extract just the number from discount_amount span
        var discountSpanText = tr.find('span[name^="discount_amount"]').text();
        var discountAmount = discountSpanText.replace('Discount:', '').replace('Discount: ', '').trim();
        productData['discount_amount']  = parseFloat(discountAmount) || 0;
    ...
    else 
    {
      ...
      $("form#addPurchaseOrderForm .field_validation").on("blur change",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
        ...
        if(value==null || value==""){
          $("form#addPurchaseOrderForm #err_"+id).text(field+ " field is required.").fadeIn('slow');
          $('form#addPurchaseOrderForm #'+id).removeClass('is-valid');
          $('form#addPurchaseOrderForm #'+id).addClass('is-invalid');
          return false;
        }
        else{
    ...
    /*  $('form#addSupplierForm #supplierSubmit').click(function(e){
      ...
      $(document).on('change', '#upload_document', function(e) {
        ...
        $.ajax({
            url: "<?php echo base_url('purchase_order/upload_documents')?>", // Replace with your server-side script URL
            type: "POST",
            data: formData,
            dataType: "JSON",
            contentType: false,
    ...
    */
    // Add freight row - COMPLETELY FIXED VERSION
function addFreightRow(type, amount = 0) {
    if ($('.freight-row').length > 0) {
        $('.freight-row').remove();
    }

    let newRow = $('<tr class="freight-row">');
    let cols = "";
    ...
    cols += '<td class="text-center">'
              ...
              + '<input type="hidden" name="freight_id" value="freight">'
            + '</td>';
    cols += '<td class="text-center freight-sr-no">•</td>';
    cols += '<td><strong>Freight Charges (' + type + ')</strong><input type="hidden" name="freight_type" value="' + type + '"></td>';
    cols += '<td><textarea name="freight_remark" class="form-control" rows="2" placeholder="Add remark..." style="width:100%;">Transport charges</textarea></td>';
    cols += '<td>NA</td>';
    cols += '<td><input type="number" class="form-control text-right freight-quantity" name="freight_quantity" value="1" min="1" style="width:100%;"></td>';
    cols += '<td>NA</td>';
    cols += '<td>NA</td>';
    cols += '<td><input type="number" class="form-control text-right freight-price" name="freight_cost" value="' + amount.toFixed(2) + '" step="0.01" min="0" style="width:100%;"></td>';
    cols += '<td>NA</td>';
    cols += '<td class="text-right freight-taxable-value">' + amount.toFixed(2) + '</td>';
    cols += '<td>N/A</td>';
    cols += '<td class="text-right freight-total-price"><strong>' + amount.toFixed(2) + '</strong></td>';

    newRow.append(cols);
    $("#product_table_body").append(newRow);
}

// Update freight values when Price/Unit changes
$(document).on('input', '.freight-price', function() {
    let amount = parseFloat($(this).val()) || 0;
    let row = $(this).closest('tr');
    
    // Calculate total = quantity * price (quantity is usually 1 for freight)
    let quantity = parseFloat(row.find('.freight-quantity').val()) || 1;
    let totalAmount = quantity * amount;
    
    // Update the taxable value and total price
    row.find('.freight-taxable-value').text(totalAmount.toFixed(2));
    row.find('.freight-total-price').html('<strong>' + totalAmount.toFixed(2) + '</strong>');
    
    // Update the additional cost amount field to match
    $('#additional_cost_amount').val(totalAmount);
    
    // Recalculate totals
    calculateGrandTotal();
});

// Update from quantity column as well
$(document).on('input', '.freight-quantity', function() {
    let quantity = parseFloat($(this).val()) || 1;
    let row = $(this).closest('tr');
    
    let price = parseFloat(row.find('.freight-price').val()) || 0;
...
$('#additional_cost_amount').on('input', function() {
    ...
    if(row.length > 0) {
        row.find('.freight-price').val(amount);
        row.find('.freight-quantity').val(1);
        row.find('.freight-taxable-value').text(amount.toFixed(2));
        row.find('.freight-total-price').html('<strong>' + amount.toFixed(2) + '</strong>');
        calculateGrandTotal();
    }
});
...
$('#additional_cost_amount').on('input', function() {
    let amount = parseFloat($(this).val()) || 0;
    $('.freight-cost').val(amount);
    $('.freight-amount').val(amount);
    $('.freight-taxable-value').text(amount.toFixed(2));
    $('.freight-total').html('<strong>' + amount.toFixed(2) + '</strong>');
    calculateGrandTotal();
});
...
$('#additional_cost_type').change(function () {
    ...
    // If there's amount, update the values
    let currentAmount = parseFloat($('#additional_cost_amount').val()) || 0;
    $('.freight-cost').val(currentAmount);
    $('.freight-amount').val(currentAmount);
    $('.freight-taxable-value').text(currentAmount.toFixed(2));
    $('.freight-total').html('<strong>' + currentAmount.toFixed(2) + '</strong>');
    calculateGrandTotal();
});

// Delete item handler - preserve freight row deletion
$('table.product_table').on('click', "span.delete_item", function(e){
    var tr = $(this).closest('tr');
    if (tr.hasClass('freight-row')) {
        $('#additional_cost_type').val('');
 ...
 $('#due_days').change(function () {
    ...
    let terms = $(this).find(':selected').data('terms') || '';

    $('#payment_terms').val(terms);

    let poDate = $('#purchase_order_date').val();
    if (poDate && days) {
        let p = poDate.split('-');
