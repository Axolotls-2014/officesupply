...
<div class="wrapper">
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <form class="form-horizontal" name="addBankAccountForm" id="addBankAccountForm" method="post" action="">
            <div class="card card-info">
              ...
              <div class="card-body">
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="account_name"  value="<?=set_value('account_name') ?>" class="form-control form-control-sm field_validation" id="account_name" placeholder="<?=$this->lang->line('bank_account_name')?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="account_number"  value="<?=set_value('account_number') ?>" class="form-control form-control-sm field_validation" id="account_number" placeholder="<?=$this->lang->line('bank_account_number')?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="bank_name"  value="<?=set_value('bank_name') ?>" class="form-control form-control-sm field_validation" id="bank_name" placeholder="<?=$this->lang->line('bank_account_bank_name')?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="ifsc"  value="<?=set_value('ifsc') ?>" class="form-control form-control-sm field_validation" id="ifsc" placeholder="<?=$this->lang->line('bank_account_ifsc')?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="description"  value="<?=set_value('description') ?>" class="form-control form-control-sm" id="description" placeholder="<?=$this->lang->line('bank_account_description')?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-4">
                    <input type="number" name="opening_balance"  value="<?=set_value('opening_balance',0.0) ?>" class="form-control form-control-sm field_validation" id="opening_balance" placeholder="<?=$this->lang->line('bank_account_opening_balance')?>" step="0.01">
...
$(document).ready(function(e){
  ...
  $('form#addBankAccountForm').submit(function(e){
    var isError = false;
    $('#bankAccountSubmit').text('<?=$this->lang->line("please_wait")?>').attr('disabled','disabled');

    $('form#addBankAccountForm .field_validation').each(function() {
        ...
        if(value==null || value==""){
          $("form#addBankAccountForm  #err_"+id).text(field+ " field is required.");
          $('form#addBankAccountForm  #'+id).addClass('is-invalid');
          isError = true;
        }
        else
        {
          $("form#addBankAccountForm #err_"+id).text("");
          $('form#addBankAccountForm #'+id).removeClass('is-invalid');
          $('form#addBankAccountForm #'+id).addClass('is-valid');
        }
  ...
  $("form#addBankAccountForm  .field_validation").on("blur change keyup",  function (event){
      var id    = $(this).attr('id');
      var value = $(this).val();
      var field = $(this).attr('placeholder');
