...
<li class="breadcrumb-item"><a href="<?php echo base_url('auth');?>"><?=$this->lang->line('home')?></a></li>
		            ...
		            <li class="breadcrumb-item active"><?=$this->lang->line('hsn_report')?></li>
		          </ol>
		        </div>
		      </div>
		    </section>
            ...
            <!-- general form elements disabled -->
            	<form role="form" id="hsnReportForm" name="hsnReportForm" method="POST" action="<?php echo base_url("report/hsn_sale") ?>" target="_blank">
	            	<div class="card card-primary">
	                  ...
	                  <div class="row">
	                    ...
	                    <div class="col-sm-3">
                          ...
                          <select class="form-control form-control-sm select2bs4" name="sale_id" id="sale_id" width="100%" class="add-row">
                            <option value=""><?=$this->lang->line('select')?></option>
                            <?php
                              foreach ($sales as $value) {
                            ?>
                              <option value="<?=$value->id;?>">
                                <?=$value->reference_no.' - '.$value->customer_name;?>
                              </option>
                            <?php 
                              }
                            ?>
                          </select>
                          <span id="err_sale_id" class="error invalid-feedback"><?=form_error('sale_id');?></span>
                        </div>
	                    </div>
	                    <div class="col-sm-3">
	                    	<div class="form-group">
		...
		$('#submitHsnReport').click(function(e){
			...
			else
			{
				...
				setTimeout(function(){ 
					...
					$.ajax({
		        url: '<?php echo base_url("report/hsn_sale") ?>',
		        type: 'POST',
		        dataType : 'json',
		        data: formData,                       
