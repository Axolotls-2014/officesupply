...
<li class="breadcrumb-item"><a href="<?php echo base_url('auth');?>"><?=$this->lang->line('home')?></a></li>
		            ...
		            <li class="breadcrumb-item active"><?=$this->lang->line('product_report')?></li>
		          </ol>
		        </div>
		      </div>
		    </section>
            ...
            <!-- general form elements disabled -->
            	<form role="form" id="productReport" name="productReport" method="POST" action="<?php echo base_url("report/product") ?>" target="_blank">
	            ...
	            <div class="card card-primary">
	              ...
	              <div class="card-body product_list">
	                <table class="sticky-header-table table table-bordered table-striped" id="product-data">
		                ...
		                <tbody>
		                  <tr>
		                  	<td colspan="14">Please click on Search button to get records</td>
		                  </tr>
		                </tbody>
		              </table>
	              </div>
...
<script type="text/javascript">
		...
		$('#submitProductReport').click(function(e){
			...
			else
			{
				...
				setTimeout(function(){ 
					...
					$.ajax({
		        url: '<?php echo base_url("report/product") ?>',
		        type: 'POST',
		        dataType : 'json',
		        data: formData,                       
    ...
    //   link.setAttribute("download", "ProductReport.csv");
