<?php 
	$sales        = $this->sale_model->get_sale_records_by_warehouse_id($warehouse->id);
  $purchases    = $this->purchase_model->get_purchase_records_by_warehouse_id($warehouse->id);
  $quotations   = $this->quotation_model->get_quotation_records_by_warehouse_id($warehouse->id);
?>
...
<div class="modal-body">
	...
	?>
		<p>
		   <?=$this->lang->line('warehouse_delete_message').$warehouse->name.' ?'?>
		</p>
	<?php
		}
	?>
...
<div class="modal-footer">
    ...
    <?php 
		  ...
		  {
		?>
    		<form action="<?php echo base_url('warehouse/delete');?>" method="POST" name="deleteWarehouseForm" id="deleteWarehouseForm">
