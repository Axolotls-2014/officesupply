                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <span id="err_hsn" class="error invalid-feedback"><!-- <?=form_error('symbol');?> --></span>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">
                    ...
                    <div class="col-sm-4">
                      <input type="number" name="markup" value="<?=set_value('markup') ?>" class="form-control form-control-sm field_validation" id="markup" placeholder="<?=$this->lang->line('product_markup')?>" step="0.1">
