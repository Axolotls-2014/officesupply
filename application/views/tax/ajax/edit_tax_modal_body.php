...
<form role="form" method="post" name="editTaxForm" id="editTaxForm">
  ...
  <div class="modal-body">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-8">
        <input type="text" name="tax_name" id="tax_name" value="<?=set_value("tax_name",$tax->tax_name) ?>" class="form-control form-control-sm field_validation" id="client_contact_person_name" placeholder="<?=$this->lang->line("tax_name")?>">
