<form  method="POST" name="createPayrollForm" id="createPayrollForm">
  ...
  <div class="modal-footer">
    ...
    <button type="button" class="btn btn-default" data-dismiss="modal">
      ...
      <button type="submit" name="createPayrollSubmit" id="createPayrollSubmit" class="btn btn-info" value=""><?php echo $this->lang->line('submit');?></button>
