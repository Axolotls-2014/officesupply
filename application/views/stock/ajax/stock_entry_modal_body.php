...
<form role="form" method="post" name="addStockForm" id="addStockForm">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <select class="form-control form-control-sm select2bs4 field_validation" name="warehouse_id" id="warehouse_id" placeholder="<?=$this->lang->line("stock_warehouse_id")?>" width="100%">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
      <select class="form-control form-control-sm select2bs4 field_validation" name="product_id" id="product_id" placeholder="<?=$this->lang->line("stock_product_id")?>" width="100%">
      ...
      ?>
        ...
        <!-- <?php
          foreach ($products as $value) {
            $product_category = $this->product_category_model->get_single_record($value->product_category_id);
            $uom = $this->uom_model->get_single_record($value->uom_id);
        ?>
          <option value="<?=$value->id;?>"
                  data-product_name="<?=$value->name?>"
                  data-product_uom="<?=$uom->uom?>"
                  data-product_uom_name="<?=$uom->name?>"
          >
            <?= $value->name.' - '.$product_category->name;?>
          </option>
        <?php 
          }
        ?> -->
