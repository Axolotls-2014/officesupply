  ...
  <div class="wrapper">
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="editSaleForm" id="editSaleForm" method="POST" action="<?=base_url('sale/edit')?>">
              <div class="card">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="due_date" name="due_date" value="<?= date('d-m-Y', strtotime($sale->invoice_date . ' + ' . $sale->due_days . ' days')); ?>" readonly>
                          <span id="err_due_date" class="error invalid-fe edback"><?=form_error('due_date');?></span>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-sm form-control">
                            <input type="hidden" name="customer_id" value="<?=$sale->customer_id?>" id="customer_id">
                            <?php
            ...
            <select class="form-control form-control-sm" id="shipping_address_select" name="shipping_address_select">
                ...
                <?php foreach ($customer_shipping_addresses as $address): ?>
                    <option value="<?= $address->id ?>" 
                        <?= ($address->id == $sale->selected_shipping_address_id) ? 'selected' : '' ?>
        ...
        <select class="form-control select2bs4" style="width: 100%;" id="due_days" name="due_days">
            ...
            <?php foreach($due_days_options as $option): ?>
                <option value="<?= $option->due_day ?>" 
                    ...
                    <?= ($sale->due_days == $option->due_day) ? 'selected' : '' ?>>
                    <?= $option->due_day ?> Days
                </option>
            <?php endforeach; ?>
        </select>
...
<input type="hidden" name="payment_terms" id="payment_terms" value="<?= $sale->payment_terms ?>">
...
<div class="col-sm-2">
    <div class="form-group">
        ...
        <input type="hidden" name="due_date" id="due_date" value="<?= date('d-m-Y', strtotime($sale->due_date)) ?>">
    </div>
</div>  
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label>Purchase Order No</label>
                                <input type="text" class="form-control" id="purchase_order_no" name="purchase_order_no" value="<?=set_value('purchase_order_no', $sale->purchase_order_no)?>">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="purchase_order_date" name="purchase_order_date" value="<?=set_value('purchase_order_date', $sale->purchase_order_date)?>">
                      ...
                      <div class="col-sm-2 <?= (empty($transporter_doc_date) || $transporter_doc_date->field_status !== 'active') ? 'd-none' : '' ?>">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="dispatch_date" name="dispatch_date" value="<?=set_value('dispatch_date', $sale->dispatch_date)?>">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label>LUT No</label>
                            <input type="text" class="form-control" id="lut_no" name="lut_no" value="<?=set_value('lut_no',$sale->lut_no)?>">
...
<table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
    <thead>
        <tr>
            ...
            <th class="span2 d-none" width="14%"><?=$this->lang->line('sale_discount')?></th>
    ...
    <tbody id="product_table_body">
        <?php foreach ($sale_items as $row) { ?>
            <tr class="product_row">
                <td>
                    ...
                    <input type="hidden" name="proforma_invoice_idd" value="<?=$row->proforma_invoice_idd?>">
                ...
                <td>
                    <input type="number" class="form-control" name="quantity" value="<?=$row->quantity?>" step="1" min="1" max="'+product.quantity+'" <?= ($row->proforma_invoice_idd != null) ? ' readonly' : '' ?>>
                </td>
                
                <td>
                    <span id="selling_price_span">
                        <input type="number" class="form-control text-right" name="selling_price" step="0.01" min="0.01" value="<?=$row->selling_price?>" <?= ($row->proforma_invoice_idd != null || empty($selling_price)) ? ' readonly' : '' ?>>
       ...
       <?php if ($sale->additional_cost_type): ?>
        ...
        <td>
            ...
            <input type="hidden" name="freight_type" value="<?= $sale->additional_cost_type ?>">
            <input type="hidden" name="freight_tax_rate" value="<?= $sale->freight_tax_rate ?>">
        </td>
        <td><span name="freight_name">Freight Charges (<?= $sale->additional_cost_type ?>)</span></td>
        ...
        <td>
            <input type="number" class="form-control text-right freight-amount" name="freight_selling_price" id="freight_selling_price" 
                   value="<?= $sale->freight_taxable_value ?>" data-freight-type="<?= $sale->additional_cost_type ?>">
        </td>
        <td>NA</td>
        <td class="d-none"></td> <!-- Discount -->
        <td>NA</td> <!-- UOM -->
        <td><span name="freight_taxable_value"><?= $sale->freight_taxable_value ?></span></td>
        <td class="tax_td">
            <?php if ($sale->additional_cost_type === 'external'): ?>
                IGST : <span name="freight_i_tax"><?= $sale->freight_tax_amount ?></span> (<span name="freight_igst"><?= $sale->freight_tax_rate ?>%</span>)
            <?php else: ?>
                N/A
            <?php endif; ?>
        </td>
        <td><span name="freight_sub_total"><?= $sale->freight_sub_total ?></span></td>
    </tr>
<?php endif; ?>
    </tbody>
</table>
...
<table class="table table-striped table-bordered table-condensed table-hover total_data" style="font-size: 18px;">
    ...
    <tr>
        <td align="right" width="66%">
            <select class="form-control" id="additional_cost_type" name="additional_cost_type" required>
                ...
                <option value="internal" <?= ($sale->additional_cost_type == 'internal') ? 'selected' : '' ?>>Internal</option>
                <option value="external" <?= ($sale->additional_cost_type == 'external') ? 'selected' : '' ?>>External</option>
            </select>
        </td>
        <td align='right' width="34%">
            <input type="number" class="form-control" id="additional_cost_amount" name="additional_cost_amount" 
                   value="<?= $sale->additional_cost_amount ?>" min="0.00" step="0.01" placeholder="Enter Amount">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td align='right' class="text-success" width="34%">
            +<span id="total_taxable_value"><?= $sale->total_taxable_value ?></span>
            <input type="hidden" name="total_taxable_value" id="t_taxable_value" value="<?= $sale->total_taxable_value ?>">
        </td>
    </tr>
    ...
    <tr>
        ...
        <td align='right' class="text-success" width="34%">
            +<span id="total_tax"><?= $sale->total_tax ?></span>
            <input type="hidden" name="total_tax" id="t_tax" value="<?= $sale->total_tax ?>">
        </td>
    </tr>
    ...
    <!--    <td align='right' width="34%">-->
    <!--        +<span id="freight_gst"><?= ($sale->additional_cost_type == 'external') ? $sale->freight_tax_amount : '0.00' ?></span>-->
    <!--        <input type="hidden" name="freight_gst" id="freight_gst_input" value="<?= ($sale->additional_cost_type == 'external') ? $sale->freight_tax_amount : '0' ?>">-->
    <!--    </td>-->
    <!--</tr>-->
    ...
    <tr>
        ...
        <td align='right' width="34%">
            <span id="total"><?= $sale->total ?></span>
            <input type="hidden" name="total" id="t" value="<?= $sale->total ?>">
        </td>
    </tr>
...
<!--<table class="table table-striped table-bordered table-condensed table-hover profit_data" style="font-size: 18px;">
    <tr>
        ...
        <td align='right' width="34%">
            <span id="total_purchase_cost"><?= $sale->total_purchase_cost ?></span>
            <input type="hidden" name="total_purchase_cost" id="t_purchase_cost" value="<?= $sale->total_purchase_cost ?>">
        </td>
    </tr>
    <tr>
        <td align="right" width="66%">Total Selling Price(<?=$currency?>)</td>
        <td align='right' width="34%">
            <span id="total_selling_price"><?= $sale->total_selling_price ?></span>
            <input type="hidden" name="total_selling_price" id="t_selling_price" value="<?= $sale->total_selling_price ?>">
        </td>
    </tr>
    <tr>
        <td align="right" width="66%">Gross Profit/Loss(<?=$currency?>)</td>
        <td align='right' width="34%">
            <span id="gross_profit_loss"><?= $sale->gross_profit_loss ?></span>
            <input type="hidden" name="gross_profit_loss" id="t_profit_loss" value="<?= $sale->gross_profit_loss ?>">
        </td>
    </tr>
    <tr>
        <td align="right" width="66%">Profit Margin(%)</td>
        <td align='right' width="34%">
            <span id="profit_margin"><?= $sale->profit_margin ?>%</span>
            <input type="hidden" name="profit_margin" id="profit_margin" value="<?= $sale->profit_margin ?>">
        </td>
    </tr>
</table>-->
                ...
                <div class="card-footer">
                  ...
                  <input type="hidden"
                   ...
                   value="<?= htmlspecialchars($sale->proforma_invoice_id ?? '') ?>">
                  ...
                  <button type="submit" name="submit" id="saleSubmit" class="btn btn-info"><?=$this->lang->line('sale_edit')?></button>
...
<script type="text/javascript">
 ...
 $(document).ready(function(e) {
    ...
    // Delegated event for freight selling price changes
 ...
 $('.supplier-select').on('change', function() {
    ...
    $(document).ready(function() {
        var selectedAddressId = '<?= $sale->selected_shipping_address_id ?>';
    ...
    var initialInvoiceDate = '<?= date("d-m-Y", strtotime($sale->invoice_date)) ?>';
    ...
    $('#due_days').change(function() {
        ...
        var invoiceDate = '<?= date("d-m-Y", strtotime($sale->invoice_date)) ?>';
    ...
    $("#product_table_body").find('tr').each(function () {
        ...
        // Get the original tax rates from hidden inputs
        var igst = parseFloat(tr.find('input[name^="igst_rate"]').val()) || 0;
        var cgst = parseFloat(tr.find('input[name^="cgst_rate"]').val()) || 0;
        var sgst = parseFloat(tr.find('input[name^="sgst_rate"]').val()) || 0;
        // Get the current tax amounts
        var c_tax = parseFloat(tax_td.find('span[name="c_tax"]').text()) || 0;
        var s_tax = parseFloat(tax_td.find('span[name="s_tax"]').text()) || 0;
        var i_tax = parseFloat(tax_td.find('span[name="i_tax"]').text()) || 0;
        ...
        if(company_country_id == customer_country_id) { 
            if(company_state_id == customer_state_id) {
                tax += 'CGST: <span name="c_tax">' + c_tax.toFixed(2) + '</span>(<span name="cgst">'+cgst+'</span>)<br/>';
                tax += 'SGST: <span name="s_tax">' + s_tax.toFixed(2) + '</span>(<span name="sgst">'+sgst+'</span>)';
                tax += '<span name="i_tax" style="display:none">' + i_tax.toFixed(2) + '</span><span name="igst" style="display:none">'+igst+'</span>';
            } else {
                tax += 'IGST: <span name="i_tax">' + i_tax.toFixed(2) + '</span>(<span name="igst">'+igst+'</span>)<br/>';
                tax += '<span name="c_tax" style="display:none">' + c_tax.toFixed(2) + '</span><span name="cgst" style="display:none">'+cgst+'</span>';
                tax += '<span name="s_tax" style="display:none">' + s_tax.toFixed(2) + '</span><span name="sgst" style="display:none">'+sgst+'</span>';
            }  
        } else {
            tax += 'N/A'; 
            tax += '<span name="i_tax" style="display:none">' + i_tax.toFixed(2) + '</span><span name="igst" style="display:none">'+igst+'</span>';
...
$(function(){
 ...
 function add_row(data, vendors) {
    ...
    var quantity = parseFloat(product.quantity) || 1;
    ...
    var taxable_value = '<span name="taxable_value">' +
    (parseFloat(product.selling_price || 0) * quantity).toFixed(2) +
'</span>';
...
$('#editSaleForm').submit(function(e) {
    ...
    if (isError) {
        $('#saleSubmit').text('<?=$this->lang->line("sale_edit")?>').removeAttr('disabled');
        return false;
    }
            ...
            <tr class="service_row freight-row">
                ...
                <td>
                    <input type="number" class="form-control text-right freight-amount" 
                           name="freight_selling_price" value="${taxableValue.toFixed(2)}" 
