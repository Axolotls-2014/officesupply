                          ...
                          <table class="table table-striped table-bordered table-condensed table-hover total_data" style="font-size: 18px;">
                            <tr>
                              ...
                              <td align='right' class="text-danger"  width="34%">
                                -<span id="total_discount"><?=$sale->total_discount?></span>
                                <input type="hidden" name="total_discount" id="t_discount" value="<?=$sale->total_discount?>">
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td align='right' class="text-success" width="34%">
                                ...
                                <input type="hidden" name="total_taxable_value" id="t_taxable_value" value="<?=$sale->total_taxable_value-$sale->tds?>">
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td align='right' class="text-success" width="34%">
                                <input type="number" class="form-control" name="tds" id="tds" value="<?=$sale->tds?>" style="text-align: right">
                              </td>
                            </tr>
                            <tr>
