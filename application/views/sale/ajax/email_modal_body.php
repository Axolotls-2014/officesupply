          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <?php 
                ...
                $replace = array($sale->reference_no, $customer->customer_name,$company_setting->company_name);
                $subject = $email_template ? str_replace($search, $replace, $email_template->subject) : $sale->reference_no;
              ?>
             

              
            
              <input type="text" name="subject" value="<?= ($email_template && $email_template->subject) ? $subject : $sale->reference_no ?>"  class="form-control form-control-sm field_validation" id="subject" placeholder="Subject">
