  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('delivery_challan_edit')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="editProformaInvoiceForm" id="editProformaInvoiceForm" method="POST" action="<?=base_url('delivery_challan/edit')?>">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('delivery_challan_edit')?></h3>

                  <div class="card-tools">

                    <ul class="nav nav-pills ml-auto">
                      <li class="nav-item  ml-2">
                        <a class="nav-link reset btn-sm btn-warning" href="#" data-tt="tooltip" title="Click here to Reset Delivery Challan Items">
                          <i class="fas fa-redo-alt"></i> Reset
                        </a>
                      </li>

                      <li class="nav-item ml-2">
                        <a class="nav-link active" href="<?=base_url('delivery_challan')?>" data-tt="tooltip" title="Click here to show Delivery Challan list"><i class="fas fa-arrow-left mr-2"></i>Back</a>
                      </li>
                  ...
                  <div class="card-tools">
                    <div class="btn-group d-none">
                      <button type="button" class="btn btn-tool btn-warning rcm_btn" data-tt="tooltip" title="<?=$this->lang->line('delivery_challan_rcm_change_status')?>">
                        <?=($delivery_challan->rcm == 'Y') ? $this->lang->line('delivery_challan_disable_rcm') : $this->lang->line('delivery_challan_enable_rcm')?>
                      </button>
                    ...
                    <div class="row">
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="reference_no" name="reference_no" value="<?=$delivery_challan->reference_no?>" readonly>
                        </div>
                      </div>
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="invoice_date" name="invoice_date" value="<?=date('d-m-Y', strtotime($delivery_challan->invoice_date))?>" placeholder="Invoice Date" autocomplete="off">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-sm">
                            ...
                            ?>
                              <option value="<?=$value->id;?>"
                                <?php 
                                  if($value->id == $delivery_challan->warehouse_id)
                                    echo ' selected';
                                ?>
                              >
                                <?= $value->name;?>
                          ...
                          <!-- <input type="hidden" name="warehouse_id" id="warehouse_id" value="<?=$delivery_challan->warehouse_id?>"> -->
                          <span id="err_warehouse_id" class="error invalid-feedback"><?=form_error('warehouse_id');?></span>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group">
                          <label for="customer"><?=$this->lang->line('delivery_challan_customer')?><span class="validation-color">*</span>
                          </label>
                          <div class="input-group input-group-sm">
                            <select class="form-control form-control-sm select2bs4 field_validation" name="customer_id" id="customer_id" width="100%" class="add-row" placeholder="<?=$this->lang->line('delivery_challan_customer')?>">
                              <option value=""><?=$this->lang->line('select')?></option>
                              <?php
                                if (!$customer_group) 
                                { 
                              ...
                              ?>
                                    <option value="<?=$value->id;?>"
                                      <?php 
                                        if($value->id == $delivery_challan->customer_id)
                                          echo ' selected';
                                      ?>
                                    >
                                      <?= $value->customer_name;?>
                          ...
                          <!-- <input type="hidden" name="customer_id" value="<?=$delivery_challan->customer_id?>" id="customer_id"> -->
            ...
            <select class="form-control form-control-sm" id="shipping_address_select" name="shipping_address_select">
                ...
                <?php foreach ($customer_shipping_addresses as $address): ?>
                    <option value="<?= $address->id ?>" 
                        <?= ($address->id == $delivery_challan->selected_shipping_address_id) ? 'selected' : '' ?>
                    ...
                    <div class="row customer_shipping_detail">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control form-control-sm select2bs4 field_validation" name="customer_shipping_country_id" id="customer_shipping_country_id" width="100%" placeholder="<?=$this->lang->line('customer_shipping_country_id')?>" tabindex="<?=$tabindex++?>">
                            ...
                            ?>
                              <option value="<?=$value->id;?>"
                                <?php 
                                  if($value->id == $delivery_challan->customer_shipping_country_id)
                                    echo ' selected';
                                ?>
                              >
                                <?= $value->name;?>
                              ...
                              ?>
                                  <option value="<?=$value->id;?>"
                                    <?php
                                      ...
                                      {
                                        if($value->id == $delivery_challan->customer_shipping_state_id)
                                          echo ' selected';
                                      }
                              ...
                              ?>
                                  <option value="<?=$value->id;?>"
                                    <?php 
                                      ...
                                      {
                                        if($value->id == $delivery_challan->customer_shipping_city_id)
                                          echo ' selected';
                                      }
                                    ?>
                                  >
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="customer_shipping_address" value="<?=$delivery_challan->customer_shipping_address?>" class="form-control field_validation" id="customer_shipping_address" placeholder="<?=$this->lang->line('customer_shipping_address')?>" tabindex="<?=$tabindex++?>"><?=form_error('shipping_address', '<div class="text-danger">', '</div>');?>
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" name="customer_shipping_pincode" value="<?=$delivery_challan->customer_shipping_pincode?>" class="form-control field_validation" id="customer_shipping_pincode" placeholder="<?=$this->lang->line('customer_shipping_pincode')?>" tabindex="<?=$tabindex++?>">
                    ...
                    <div class="row">
                      <div class="col-sm-3 <?= (empty($lr_no) || $lr_no->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="lori_no" name="lori_no" value="<?=set_value('lori_no',$delivery_challan->lori_no)?>">
                      ...
                      <div class="col-sm-3 <?= (empty($lr_date) || $lr_date->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="lori_date" name="lori_date" value="<?=set_value('lori_date',(($delivery_challan->lori_date != '' && $delivery_challan->lori_date != '0000-00-00') ? date('d-m-Y',strtotime($delivery_challan->lori_date)) : '' ))?>" autocomplete="off">
                      ...
                      <div class="col-sm-3 <?= (empty($carrier) || $carrier->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="carrier" name="carrier" value="<?=set_value('carrier',$delivery_challan->carrier)?>">
                      ...
                      <div class="col-sm-2 d-none">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" value="<?=set_value('vehicle_no',$delivery_challan->vehicle_no)?>">
                      ...
                      <div class="col-sm-3 <?= (empty($ewaybill_no) || $ewaybill_no->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="ewaybill_no" name="ewaybill_no" value="<?=set_value('ewaybill_no',$delivery_challan->ewaybill_no)?>">
                      ...
                      <div class="col-sm-2 d-none">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="additional_case" name="additional_case" value="<?=set_value('additional_case',$delivery_challan->additional_case)?>">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control ewaybill_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('delivery_challan_ewaybill_dispatch_from')?>" id="ewaybill_dispatch_from" name="ewaybill_dispatch_from">
                            ...
                            ?>
                                <option value="<?=$st->id?>"
                                  <?php 
                                    if($st->id == $delivery_challan->ewaybill_dispatch_from)
                                      echo ' selected';
                                  ?>  
                                >
                          ...
                          <select class="form-control ewaybill_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('delivery_challan_ewaybill_mode_of_transportation')?>" id="ewaybill_mode_of_transportation" name="ewaybill_mode_of_transportation">
                            ...
                            ?>
                                <option value="<?=$ewaybill_mode_of_transportation_array[$i]?>"
                                  <?php 
                                    if($ewaybill_mode_of_transportation_array[$i] == $delivery_challan->ewaybill_mode_of_transportation)
                                      echo ' selected';
                                  ?>
                                >
                          ...
                          <select class="form-control ewaybill_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('delivery_challan_ewaybill_subtype')?>" id="ewaybill_subtype" name="ewaybill_subtype">
                            ...
                            ?>
                                <option value="<?=$ewaybill_subtype_array[$i]?>"
                                  <?php 
                                    if($ewaybill_subtype_array[$i] == $delivery_challan->ewaybill_subtype)
                                      echo ' selected';
                                  ?>
                                >
                          ...
                          <select class="form-control ewaybill_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('delivery_challan_ewaybill_doctype')?>" id="ewaybill_doctype" name="ewaybill_doctype">
                            ...
                            ?>
                                <option value="<?=$ewaybill_doctype_array[$i]?>"
                                  <?php 
                                    if($ewaybill_doctype_array[$i] == $delivery_challan->ewaybill_doctype)
                                      echo ' selected';
                                  ?>
                                >
                      ...
                      <div class="col-sm-2 <?= (empty($transporter_gstin) || $transporter_gstin->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " id="ewaybill_transporter_gstin" name="ewaybill_transporter_gstin" value="<?=set_value('ewaybill_transporter_gstin',$delivery_challan->ewaybill_transporter_gstin)?>">
                      ...
                      <div class="col-sm-2 <?= (empty($transporter_name) || $transporter_name->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control " id="ewaybill_transporter_name" name="ewaybill_transporter_name" value="<?=set_value('ewaybill_transporter_name',$delivery_challan->ewaybill_transporter_name)?>">
                      ...
                      <div class="col-sm-2 <?= (empty($distance_of_transportation) || $distance_of_transportation->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" id="ewaybill_distance_of_transportation" name="ewaybill_distance_of_transportation" value="<?=set_value('ewaybill_distance_of_transportation',$delivery_challan->ewaybill_distance_of_transportation)?>" step="0.01">
                      ...
                      <div class="col-sm-2 <?= (empty($transporter_doc_no) || $transporter_doc_no->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="ewaybill_transporter_doc_no" name="ewaybill_transporter_doc_no" value="<?=set_value('ewaybill_transporter_doc_no',$delivery_challan->ewaybill_transporter_doc_no)?>">
                      ...
                      <div class="col-sm-2 <?= (empty($transporter_doc_date) || $transporter_doc_date->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control datepicker" id="ewaybill_transporter_doc_date" name="ewaybill_transporter_doc_date" value="<?=set_value('ewaybill_transporter_doc_date',(($delivery_challan->ewaybill_transporter_doc_date != '') ? date('d-m-Y',strtotime($delivery_challan->ewaybill_transporter_doc_date)) : ''))?>" autocomplete="off">
                      ...
                      <div class="col-sm-2 <?= (empty($eway_vehicle_no) || $eway_vehicle_no->field_status !== 'active') ? 'd-none' : '' ?>">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="ewaybill_vehicle_no" name="ewaybill_vehicle_no" value="<?=set_value('ewaybill_vehicle_no',$delivery_challan->ewaybill_vehicle_no)?>">
                          ...
                          <select class="form-control ewaybill_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('delivery_challan_ewaybill_vehicle_type')?>" id="ewaybill_vehicle_type" name="ewaybill_vehicle_type">
                            ...
                            ?>
                                <option value="<?=$ewaybill_vehicle_type_array[$i]?>"
                                  <?php 
                                    if($ewaybill_vehicle_type_array[$i] == $delivery_challan->ewaybill_vehicle_type)
                                      echo ' selected';
                                  ?>
                                >
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="hidden" value="<?= $delivery_challan->document ?>" name="document[]" id="document">
                            </div>
                            <span id="fileTypeError" class="error-message"></span>
                            <?php
                              $document_filenames = explode(',', $delivery_challan->document);
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
                              <thead>
                                <tr>
                                  ...
                                  <th class="span2" width="8%"><?=$this->lang->line('delivery_challan_ordered_qty')?></th>
                                  <th class="span2" width="8%"><?=$this->lang->line('delivery_challan_qty')?></th>
                                  <th class="span2 <?= (empty($promotion) || $promotion->field_status !== 'active') ? 'd-none' : '' ?>" width="8%"><?=$this->lang->line('delivery_challan_free_qty')?></th>
                                  <th class="span2" width="8%"><?=$this->lang->line('delivery_challan_total_qty')?></th>
                                  <th class="span2 <?= (empty($batch_no) || $batch_no->field_status !== 'active') ? 'd-none' : '' ?>" width="10%"><?=$this->lang->line('delivery_challan_batch')?></th>
                                  <th class="span2"width="10%"><?=$this->lang->line('customer_margin')?></th>
                                  <th class="span2" width="10%"><?=$this->lang->line('delivery_challan_selling_price')?></th>
                                  <th class="span2" width="10%"><?=$this->lang->line('delivery_challan_price')?></th>
                                  ...
                                  <th class="span2" width="14%"><?=$this->lang->line('delivery_challan_discount')?></th>
                                  <th class="span2" width="11%"><?=$this->lang->line('delivery_challan_uom')?></th>
                                  <th class="span2" width="8%"><?=$this->lang->line('delivery_challan_taxable_value')?></th>
                                  <th class="span2" width="12%"><?=$this->lang->line('delivery_challan_tax')?></th>
                                  <th class="span2" width="5%"><?=$this->lang->line('delivery_challan_inclusive')?></th>
                                  <th class="span2" width="7%"><?=$this->lang->line('delivery_challan_total')?></th>
                                </tr>
                              </thead>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <input type="number" class="form-control" name="quantity" value="<?=$row->quantity?>"  step="0.01" min="0.01" max="<?=$row->quantity?>" readonly>
                                      <span>MAX: <?=$row->quantity?></span><span data-tt="tooltip" title="Available qty in warehouse"><i class="far fa-question-circle" style="float:right;font-size:11px;padding-top:5px"></i></span><br/>
                                    ...
                                    <td <?= (empty($promotion)) ? 'class="d-none"' : '' ?>>
                                      <input type="number" class="form-control" name="free_quantity" value="<?= (empty($promotion)) ? '0.00' : ($row->free_quantity) ?>" step="0.01" min="0.00" readonly>
                                    </td>
                                    
                                    <td><span name="total_quantity"><?=$row->total_quantity?></span></td>

                                    <td <?= (empty($batch_no)) ? 'class="d-none"' : '' ?>>
                                      <input type="text" list="batch_no_<?=$row->warehouse_product_id?>" class="form-control batch_no_list" name="batch_no" value="<?=$row->batch_no?>" autocomplete="off" <?=($is_customer) ? 'readonly' : ''?>  required>
                                      <datalist class="batch_datalist" id="batch_no_<?=$row->warehouse_product_id?>">
                                        <?php 
                                          $batch_nos = $this->warehouse_products_model->get_batch_nos_by_product_id($row->product_id);
                                          foreach ($batch_nos as $value) {
                                        ?>    
                                        
                                            <option value="<?=$value->batch_no?>" data-price="<?=$value->price?>" data-cost="<?=$value->product_price?>" data-selling_price="<?=$value->selling_price?>">
                                        <?php 
                                          }
                                        ?>
                                      </datalist>
                                    ...
                                    <td>
                                      <input type="number" class="form-control" name="individual_margin" value="<?=$row->individual_margin?>" min="0" max="50" step="any" <?=($is_customer) ? 'readonly' : ''?>>
                                    </td>
                                    
                                    <td>
                                      <span id="selling_price_span">
                                        <input type="number" class="form-control text-right" name="selling_price" step="0.01" value="<?=$row->selling_price?>" <?=($is_customer) ? 'readonly' : ''?> required>
                                        <input type="hidden" name="cost" value="<?=$row->product_price?>">
                                      </span>
                                    </td>

                                    <td>
                                      <span id="price_span">
                                        <input type="number" class="form-control text-right" name="price" step="0.01" value="<?=$row->price?>" <?=($is_customer) ? 'readonly' : ''?> required>
                                      </span>
                                    </td>
                          ...
                          <table class="table table-striped table-bordered table-condensed table-hover total_data">
                            <tr>
                              <td align="right"  width="66%"> <?=$this->lang->line('delivery_challan_total_discount')?>(<?=$currency?>)</td>
                              <td align='right' class="text-danger"  width="34%">
                                -<span id="total_discount"><?=$delivery_challan->total_discount?></span>
                                <input type="hidden" name="total_discount" id="t_discount" value="<?=$delivery_challan->total_discount?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('delivery_challan_total_taxable_value')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                +<span id="total_taxable_value"><?=$delivery_challan->total_taxable_value?></span>
                                <input type="hidden" name="total_taxable_value" id="t_taxable_value" value="<?=$delivery_challan->total_taxable_value-$delivery_challan->tds?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('delivery_challan_total_tax')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                +<span id="total_tax"><?=$delivery_challan->total_tax?></span>
                                <input type="hidden" name="total_tax" id="t_tax" value="<?=$delivery_challan->total_tax?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right" width="66%"><?=$this->lang->line('tds')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                <input type="number" class="form-control" name="tds" id="tds" value="<?=$delivery_challan->tds?>" <?=($customer_group) ? 'readonly' : '' ?> style="text-align: right">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('delivery_challan_total')?>(<?=$currency?>)</td>
                              <td align='right' width="34%">
                                <span id="total"><?=$delivery_challan->total?></span>
                                <input type="hidden" name="total" id="t" value="<?=$delivery_challan->total?>">
                              </td>
                            </tr>
                          </table>
                            ...
                            <div class="tabbable">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="external_note">
                                  <textarea class="col-sm-12 form-control" name="external_note" rows="4" placeholder="<?php echo $this->lang->line('delivery_challan_external_note'); ?>"><?=str_replace("<br />","",$delivery_challan->external_note)?></textarea>
                                </div>
                                <div class="tab-pane" id="internal_note">
                                  <textarea class="col-sm-12 form-control" name="internal_note" rows="4" placeholder="<?php echo $this->lang->line('delivery_challan_internal_note'); ?>"><?=str_replace("<br />","",$delivery_challan->internal_note)?></textarea>
                                </div>
                                <div class="tab-pane" id="bank_detail">
                                  <textarea class="col-sm-12 form-control" name="bank_detail" rows="4" placeholder="<?php echo $this->lang->line('delivery_challan_bank_detail'); ?>"><?=str_replace("<br />","",$delivery_challan->bank_detail)?></textarea>
                                </div>
                                <div class="tab-pane" id="terms_and_condition">
                                  <textarea class="col-sm-12 form-control" name="terms_and_condition" rows="4" placeholder="<?php echo $this->lang->line('delivery_challan_terms_and_condition'); ?>"><?=str_replace("<br />","",$delivery_challan->terms_and_condition)?></textarea>
                                </div>
                              </div>
                            </div>   
                          </div>
                ...
                <div class="card-footer">
                  ...
                  <input type="hidden" name="rcm" id="rcm" value="<?=$delivery_challan->rcm?>">
                  <input type="hidden" name="id" value="<?=$delivery_challan->id?>">
  ...
  <div class="modal fade" id="reset_model" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>
            <?php echo "Are you sure want to reset this Delivery Challan ?";?>
          </p>
        </div>
        <div class="modal-footer">
    ...
    $(document).ready(function() {
      ...
      function add_row(product,discounts,batch_nos,quantity = null,ordered_quantity=null)
      {
        ...
        var newRow = $('<tr class="service_row">');
            ...
            cols += '<td class="<?php echo empty($batch_no) ? 'd-none' : ''; ?>"><input type="text" list="batch_no_'+product.warehouse_products_id+'" name="batch_no"  value="'+product.batch_no+'" class="form-control batch_no_list" autocomplete="off" <?=($is_customer == 'yes') ? 'readonly' : ''?> required>';
            cols +=   '<datalist class="batch_datalist" id="batch_no_'+product.warehouse_products_id+'">';

            //               for (var i=0; i < batch_nos.length; i++) 
            //               { 
            // cols +=         '<option value="'+batch_nos[i].batch_no+'" data-price="'+batch_nos[i].price+'" data-cost="'+batch_nos[i].product_price+'" data-selling_price="'+batch_nos[i].selling_price+'">';
            //               }
            ...
            //             +'<input type="hidden" name="cost" value="'+product.product_price+'">'
            //           +'</span>'
            //         +'</td>';
     ...
     function calculateFreeQuantity(productId, orderedQuantity, tr = null) {
      ...
      function calculateRow(row)
      {
        ...
        if(tax_type == 0)
        {
          ...
          row.find('span[name="total_quantity"]').text((quantity+free_quantity).toFixed(2));
        ...
        else
        {
          ...
          row.find('span[name="total_quantity"]').text((parseFloat(quantity)+parseFloat(free_quantity)).toFixed(2));
      ...
      $('#editProformaInvoiceForm').submit(function(e){
        ...
        {
          isError = true;
          $('#emptydelivery_challanItemWarningModal').modal('show');
        }
