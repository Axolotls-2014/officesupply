      ...
      <div class="row mb-2">
        <div class="col-sm-12">
          <ol class="breadcrumb breadcrumb-custom float-sm-left">
            ...
            <li class="breadcrumb-item"><a href="#"><?=$this->lang->line('purchase_return_header')?></a></li>
            <li class="breadcrumb-item active"><?=$this->lang->line('purchase_return_list')?></li>
          </ol>
        </div>
      </div>
    </section>
        ...
        <div class="col-12 col-sm-12 col-md-4">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?=$this->lang->line('total_purchase_returns')?></span>
              <span class="info-box-number" style="font-size: 19px">
                ...
                <?=($total_purchase_return == 0) ? '0.000' : number_format_i($total_purchase_return)?>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12 col-sm-12 col-md-4">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" style="font-size: 19px">
                <?=$this->session->userdata('currency_symbol')?>
                <?=(($total_purchase_return-$total_paid_amount) == 0 ) ? '0.000' : number_format_i(($total_purchase_return-$total_paid_amount))?>                  
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title"><?=$this->lang->line('purchase_return_list')?></h3>
              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  <li class="nav-item">
                    <a class="nav-link active" href="<?=base_url('purchase_return/add')?>" data-tt="tooltip" title="Click here to Add Purchase Return"><i class="far fa-snowflake mr-2"></i><?=$this->lang->line('purchase_return_add')?></a>
                  </li>
                </ul>
              </div>
              <?php 
              ...
              <table id="example" class="table table-bordered table-striped">
                <thead>
                  <tr>
                   <th>Sr.No</th>
                    ...
                    <th>Return Status</th>
                    <th width="15%"><?=$this->lang->line('purchase_return_action')?></th>
                  </tr>
                </thead>
                <tbody>
                ...
                <tfoot>
                  ...
                  <!-- <th><?="Discount" . ' (' . $this->session->userdata('currency_symbol') . ')'?></th>-->
                    ...
                    <th><?=$this->lang->line('due')?></th>
                    <th>Return Status</th>
                    <th><?=$this->lang->line('purchase_return_action')?></th>
                  </tr>
                </tfoot>
              </table>
            </div>
...
<div class="example-modal">
  <div class="modal fade" id="delete_purchase_return">
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    $('.email_invoice').click(function(e){
      ...
      $.ajax({
        url: "<?php echo base_url('purchase_return/email_invoice') ?>",
        type: "POST",
        dataType: "json",
        data:{
          'purchase_return_id' : purchase_return_id,
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    const EmailToast = Swal.mixin({
           ...
           /*************************** Start Dynamic purchase_return List with Datatables **************************/
    ...
    $(document).on('show.bs.modal','#delete_purchase_return', function (e) {
      var purchase_return_id = $(e.relatedTarget).data('purchase_return_id');
      $('#delete_purchase_return').find('#id').val(purchase_return_id);

      // alert(purchase_return_id);

      $.ajax({
        url: "<?php echo base_url('purchase_return/purchase_return_delete_confirmation')?>",
        type: "POST",
        data:{
          'purchase_return_id': purchase_return_id,
          '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
        ...
        dataType: "JSON",
        success: function(data){
          $('#delete_purchase_return').find('.modal-content').html(data.purchase_return_delete_modal_body);
        }
      });
    ...
    $(document).on('submit','#deletepurchaseReturnForm',function(e){
      $('#deletepurchaseReturnSubmit').text('<?=$this->lang->line('please_wait')?>').attr('disabled','disabled');
    });
    ...
    /*************************** End Dynamic purchase_return List with Datatables ****************************/
    ...
    $(document).on('click','.email-modal',function(e){
      ...
      $.ajax({
        url: "<?php echo base_url('purchase_return/send_email')?>/"+purchase_return_id,
        type: "GET",
        dataType: "JSON",
        success: function(data){
    ...
    $(document).on('submit','#sendEmailForm',function(e){
      ...
      {
        $.ajax({
        url: "<?php echo base_url('purchase_return/send_email')?>",
          type: "POST",
          data: formData,
          dataType: "JSON",
