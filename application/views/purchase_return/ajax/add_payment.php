...
<div class="form-group row">
  ...
  <div class="col-sm-4">
    <input type="number" name="transaction_amount" value="<?=$purchase_return->total-$paid_amount?>" class="form-control form-control-sm field_validation" id="transaction_amount" placeholder="<?=$this->lang->line('transaction_amount')?>" max="<?=$purchase_return->total-$paid_amount?>">
