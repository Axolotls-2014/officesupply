        ...
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <?php 
              ...
              $replace = array($purchase_return->reference_no, $supplier->company_name,$company_setting->company_name);
              $subject = $email_template ? str_replace($search, $replace, $email_template->subject) : $purchase_return->reference_no;
            ?>




              <input type="text" name="subject" value="<?= ($email_template && $email_template->subject) ? $subject : $purchase_return->reference_no ?>"  class="form-control form-control-sm field_validation" id="subject" placeholder="Subject">
