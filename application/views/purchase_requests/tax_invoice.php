...
@media (max-width: 1280px) {
 ...
 <div class="container mt-5 w-70" style="max-width:60%; margin:0 auto; float:none;">
           ...
           <table>
                <!-- Billing/Shipping/Transport -->
                 <tr class="heading">
                            ...
                            <td colspan="3" style="width:25%;">Transportation Details</td>
                            <td colspan="3" style="width:25%;">Purchase Order Details</td>
                        </tr>
                        <tr class="details">
                          <td colspan="3" style="width:25%;">
                            ...
                            <td colspan="3" style="width:25%;">
                                <!--Delivery Location: <?= $customer->address ?? 'N/A'; ?><br>-->
    ...
    <?php endif; ?>
            ...
            <!-- Items -->
                <table>
                    ...
                    <tr class="item">
                        <td><?= $i++; ?></td>
                        <td style="width:25%;"><?= $order->product_name; ?></td>
     ...
     <!-- Footer -->
           ...
           <!-- Buttons -->
            <div class="no-print text-center mt-6">
              ...
              <a href="<?= base_url('Order_requests/download_pdf/' . base64_encode($sale->id)); ?>" class="btn btn-danger">Download PDF</a>
            </div>
        </div> <!-- /.container -->
    </div>
</main>
