                              ...
                              <?php
                                switch ($purchase->status) {
                                    ...
                                    case 'delivered':
                                        ...
                                        break;
                                    case 'rejected':
                                        echo '<span class="badge badge-success text-uppercase">Rejected</span>';
                                        break;
                                    default:
                            ...
                            <td>
                                <?php
                                    if ($purchase->order_status == 'approved') {
                                        $txt = 'Approved From Head Office';
                                        $clr = 'text-info';
                                    } elseif ($purchase->order_status == 'rejected') {
                                        $txt = 'Rejected';
                                        $clr = 'text-danger';
                                    } elseif ($purchase->order_status == 'partially_approved') {
                                        $txt = 'Partially Approved From Manager';
                                        $clr = 'text-dark';
                                    } else {
                                        $txt = 'Pending';
                                        $clr = 'text-secondary';
                                    }
                                    echo "<span class='{$clr}'>{$txt}</span>";
                                ?>
