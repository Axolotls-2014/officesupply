  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('expense_category_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addexpenseCategoryForm" id="addexpenseCategoryForm" method="post" action="<?=base_url('expense_category/add')?>">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('expense_category_add')?></h3>
                </div>
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="description" value="<?=set_value('description') ?>" class="form-control form-control-sm field_validation" id="description" placeholder="<?=$this->lang->line('expense_category_description')?>"><?=form_error('description', '<div class="text-danger">', '</div>');?>
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="submit" id="expenseCategorySubmit" class="btn btn-info"><?=$this->lang->line('expense_category_save')?></button>
...
<script type="text/javascript">
  ...
  $(document).ready(function(e){
    ...
    $('form#addexpenseCategoryForm').submit(function(e){
      // e.preventDefault();
      ...
      if(isError == true)
      {
        $('#expenseCategorySubmit').text('<?=$this->lang->line("expense_category_save")?>').removeAttr('disabled');
        return false;
      }  
      else 
      {
