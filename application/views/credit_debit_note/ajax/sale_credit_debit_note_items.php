    ...
    <?php 
      ...
      if(sizeof($records) >  0)
      {
        foreach ($records as $value) 
        {
          ...
          $total_old_subtotal += $value->sub_total;
    ?>
          <tr>
            <td>
              <input type="hidden" name="entry_id" value="<?=$value->sale_id?>">              
            ...
            <td>
              <span name="old_sub_total"><?=$value->sub_total?></span>
            </td>
            <td>
            ...
            <td>
              <span name="new_sub_total"><?=$value->sub_total?></span>
            </td>
          </tr> 
    <?php 
        }
