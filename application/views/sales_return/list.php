      ...
      <div class="row mb-2">
        <div class="col-sm-12">
          <ol class="breadcrumb breadcrumb-custom float-sm-left">
            ...
            <li class="breadcrumb-item active"><?=$this->lang->line('sales_return_list')?></li>
          </ol>
        </div>
      </div>
    </section>
        ...
        <div class="col-12 col-sm-12 col-md-4">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text"><?=$this->lang->line('total_sales_return')?></span>
              <span class="info-box-number" style="font-size: 19px">
                ...
                <?=($total_sales_return == 0) ? '0.000' : number_format_i($total_sales_return)?>
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12 col-sm-12 col-md-4">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number" style="font-size: 19px">
                <?=$this->session->userdata('currency_symbol')?>
                <?=(($total_sales_return-$total_paid_amount) == 0 ) ? '0.000' : number_format_i(($total_sales_return-$total_paid_amount))?>                  
              </span>
            </div>
            <!-- /.info-box-content -->
          </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                <?=$this->lang->line('sales_return_list')?> 
              ...
              <div class="card-tools">
                <ul class="nav nav-pills ml-auto">
                  ...
                  ?>
                      <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('sales_return/add')?>" data-tt="tooltip" title="Click here to Add Sales Return"><i class="far fa-snowflake mr-2"></i><?=$this->lang->line('sales_return_add')?></a>
                      </li>
                  <?php
                    }
                  ?>
              ...
              <table id="example" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th width="15%"><?=$this->lang->line('sales_return_action')?></th>
                  </tr>
                </thead>
                <tbody>
                ...
                <tfoot>
                  <tr>
                    ...
                    <th><?=$this->lang->line('due')?></th>
                    <th><?=$this->lang->line('delivery_status')?></th>
                    <th><?=$this->lang->line('sales_return_action')?></th>
                  </tr>
                </tfoot>
              </table>
            </div>
...
<div class="example-modal">
  <div class="modal fade" id="delete_sales_return">
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    $('.email_invoice').click(function(e){
      ...
      var sales_return_id = $(this).data('sales_return_id');
      var i_icon = $(this);
      ...
      $.ajax({
        url: "<?php echo base_url('sales_return/email_invoice') ?>",
        type: "POST",
        dataType: "json",
        data:{
          'sales_return_id' : sales_return_id,
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    $(document).on('show.bs.modal','#delete_sales_return', function (e) {
      var sales_return_id = $(e.relatedTarget).data('sales_return_id');
      $('#delete_sales_return').find('#id').val(sales_return_id);

      // alert(sales_return_id);

      $.ajax({
        url: "<?php echo base_url('sales_return/sales_return_delete_confirmation')?>",
        type: "POST",
        data:{
          'sales_return_id': sales_return_id,
          '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
        ...
        dataType: "JSON",
        success: function(data){
          $('#delete_sales_return').find('.modal-content').html(data.sales_return_delete_modal_body);
        }
      });
    ...
    $(document).on('submit','#deletesalesReturnForm',function(e){
      $('#deletesalesReturnSubmit').text('<?=$this->lang->line('please_wait')?>').attr('disabled','disabled');
    });
    ...
    $(document).on('click','.email-modal',function(e){
      ...
      $.ajax({
        url: "<?php echo base_url('sales_return/send_email')?>/"+sales_return_id,
        type: "GET",
        dataType: "JSON",
        success: function(data){
    ...
    $(document).on('submit','#sendEmailForm',function(e){
      ...
      {
        $.ajax({
        url: "<?php echo base_url('sales_return/send_email')?>",
          type: "POST",
          data: formData,
          dataType: "JSON",
