<form method="POST" name="sendEmailForm" id="sendEmailForm">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="email" name="to_mail" value="<?=$customer->email?>" placeholder="To Email"  class="form-control form-control-sm field_validation" id="to_mail">
              <input type="hidden" name="to_name" value="<?=$customer->customer_name?>" placeholder="To Email"  class="form-control form-control-sm field_validation" id="to_name">
        ...
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <?php 
              ...
              $replace = array($sales_return->reference_no, $customer->customer_name,$company_setting->company_name);
              $subject = $email_template ? str_replace($search, $replace, $email_template->subject) : $sales_return->reference_no;
            ?>




            <input type="text" name="subject" value="<?= ($email_template && $email_template->subject) ? $subject : $sales_return->reference_no ?>"  class="form-control form-control-sm field_validation" id="subject" placeholder="Subject">
  ...
  <div class="modal-footer">
    ...
    <input type="hidden" name="sales_return_id" value="<?=$sales_return->id?>">
