      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <input type="email" name="to_mail" value="<?=$customer->email?>"  class="form-control form-control-sm field_validation" id="to_mail">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <?php 
                ...
                $replace = array($proforma_invoice->reference_no, $customer->customer_name,$company_setting->company_name);
                $subject = $email_template ? str_replace($search, $replace, $email_template->subject) : $proforma_invoice->reference_no;
              ?>

              <input type="text" name="subject" value="<?= ($email_template && $email_template->subject) ? $subject : $proforma_invoice->reference_no ?>"  class="form-control form-control-sm field_validation" id="subject" placeholder="Subject">
