  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('proforma_invoice_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addProformaInvoiceForm" id="addProformaInvoiceForm" method="POST" action="<?=base_url('proforma_invoice/add')?>">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('proforma_invoice_add')?></h3>
                  ...
                  <div class="card-tools">
                    ...
                    <div class="btn-group d-none">
                      <button type="button" class="btn btn-tool btn-warning rcm_btn" data-tt="tooltip" title="<?=$this->lang->line('proforma_invoice_rcm_change_status')?>">
                        <?=$this->lang->line('proforma_invoice_enable_rcm')?>
                      </button>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="purchase_order_no" name="purchase_order_no" value="" placeholder="Purchase Order No" autocomplete="off">
                        </div>
                      </div>
                      <div class="col-sm-2">
                        <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control" id="margin" name="margin" value="0" step="0.01" max="50" <?=($customer_group) ? 'readonly' : ''?>>
...
<div class="col-sm-2">
    <div class="form-group">
        <label for="customer">
            <?=$this->lang->line('proforma_invoice_customer')?>
            <span class="text-danger">*</span>
        </label>
        <div class="input-group input-group-sm">
           <select class="form-control form-control-sm select2bs4 field_validation" 
                ...
                width="100%" 
                class="add-row" 
                placeholder="<?= $this->lang->line('proforma_invoice_customer') ?>" 
                required>
                            ...
                            <div class="tabbable">
                              ...
                              <div class="tab-content">
                                <div class="tab-pane active" id="external_note">
                                  <textarea class="col-sm-12 form-control" name="external_note" rows="4" placeholder="<?php echo $this->lang->line('proforma_invoice_external_note'); ?>"></textarea>
                                </div>
                                <div class="tab-pane" id="internal_note">
                                  <textarea class="col-sm-12 form-control" name="internal_note" rows="4" placeholder="<?php echo $this->lang->line('proforma_invoice_internal_note'); ?>"></textarea>
                                </div>
                                <div class="tab-pane" id="bank_detail">
                                  <textarea class="col-sm-12 form-control" name="bank_detail" rows="4" placeholder="<?php echo $this->lang->line('proforma_invoice_bank_detail'); ?>"><?=str_replace("<br />","",$company_setting->bank_detail)?></textarea>
                                </div>
                                <div class="tab-pane" id="terms_and_condition">
                                  <textarea class="col-sm-12 form-control" name="terms_and_condition" rows="4" placeholder="<?php echo $this->lang->line('proforma_invoice_terms_and_condition');?>"><?=str_replace("<br />","",$company_setting->terms_and_condition)?></textarea>
                                </div>
                              </div>
                            </div>   
                          </div>
...
$(function(){
    $('#search_product').autoComplete({
      ...
      $(document).on('click', ".import_product_modal" ,function(event){
        ...
        {
          $.ajax({
            url: "<?php echo base_url('proforma_invoice/import_product')?>",
            type: "GET",
            dataType: "JSON",
            success: function(data){
...
function add_row(product, discounts, batch_nos, vendors, quantity = null, ordered_quantity = null) {
    ...
    var input_uom = '<input type="hidden" name="uom_id" value="' + product.uom_id + '">' +
        ...
        var input_quantity = "";
        input_quantity += '<input type="number" class="form-control field_validation" name="quantity" min="1" step="' + 
        (product.manage_inventory == '<?=MANAGE_INVENTORY_NO?>' ? '0.01' : '1') + 
    ...
    calculateRow(newRow);
      ...
      $("table.product_table").on('change', 'input[name^="price"], input[name^="quantity"], input[name="free_quantity"], select[name^="item_discount"]', function (event) {
        ...
        $(document).on('change', 'input[name="quantity"], input[name="price"], .supplier-select', function() {
     ...
     $(document).on('click','.apply_margin',function(event){
      ...
      $(document).on('change keyup','input[name="individual_margin"]',function(event){
        ...
        else if(margin == 0)
        {
          ...
          tr.find('input[name="price"]').val(selling_price);
          tr.find('input[name="price"]').trigger('keyup');
    ...
    //   });
        ...
        $("form#addQuotationForm #err_"+id).text("Quantity must be greater than 0.").fadeIn('slow');
