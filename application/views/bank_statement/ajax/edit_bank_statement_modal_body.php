...
<form role="form" method="post" name="editcashBankEntryForm" id="editcashBankEntryForm">
  ...
  <div class="modal-body">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-9">
        <input type="text" name="reference_no" value="<?=set_value("reference_no",$cash_bank_entry->reference_no) ?>" class="form-control form-control-sm" id="reference_no" disabled="disabled" placeholder="<?=$this->lang->line('cash_bank_entry_reference_no')?>">
      </div>
    </div>
