  ...
  <div class="modal-body">
      ...
      <div class="form-group row">
        <label for="inputEmail3" class="col-sm-4 col-form-label">
          <?=$this->lang->line("tax_tax_name")?><span class="text-danger">*</span>
        </label>
        <div class="col-sm-8">
          <input type="text" name="tax_name" value="<?=set_value("tax_name") ?>" class="form-control form-control-sm field_validation" id="tax_name" placeholder="<?=$this->lang->line("tax_tax_name")?>">
