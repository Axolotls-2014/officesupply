  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('scrap_issue_edit')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="editScrapissueForm" id="editScrapissueForm" method="POST" action="<?=base_url('scrap_issue/edit')?>">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('scrap_issue_edit')?></h3>
                  <div class="card-tools">
                    
                    <ul class="nav nav-pills ml-auto">

                      <li class="nav-item ml-2">
                        <a class="nav-link active btn btn-sm" href="<?=base_url('scrap_issue')?>" data-tt="tooltip" title="Click here to show scrap issue list"><i class="fas fa-arrow-left mr-2"></i>Back</a>
                      </li>
                   

                      <li class="nav-item  ml-2">
                        <button type="submit" name="submit" id="ScrapissueSubmit" class="btn btn-info"><?=$this->lang->line('scrap_issue_save')?></button>
                      </li>
                ...
                <div class="card-body">
                  <div class="col-sm-12">
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label><?=$this->lang->line('scrap_issue_reference_no')?></label>
                          <input type="text" class="form-control" id="reference_no" name="reference_no" value="<?=$scrap_issue->reference_no?>" readonly>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label><?=$this->lang->line('scrap_issue_date')?></label>
                          <input type="text" class="form-control datepicker" id="scrap_issue_date" name="scrap_issue_date" value="<?=date('d-m-Y', strtotime($scrap_issue->scrap_issue_date))?>" placeholder="Pack Slip Date">
                          <span id="err_scrap_issue_date" class="error invalid-feedback"><?=form_error('scrap_issue_date');?></span>
                        </div>
                      </div>
                      <?php
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <select class="form-control form-control-sm select2bs4 field_validation" name="supplier_id" id="supplier_id" width="100%" class="add-row" placeholder="<?=$this->lang->line('purchase_supplier')?>">
                            ...
                            ?>
                              <option value="<?=$value->id;?>"
                                ...
                                <?php 
                                  if($value->id == $scrap_issue->supplier_id)
                                    echo ' selected';
                                ?>
                              >
                                <?= $value->company_name;?>
                          ...
                          <input type="hidden" name="supplier_state_id" id="supplier_state_id" value="<?=($supplier_detail != null) ? $supplier_detail->state_id : ''?>">
                          <input type="hidden" name="supplier_country_id" id="supplier_country_id" value="<?=($supplier_detail != null) ? $supplier_detail->country_id : ''?>">
                    ...
                    <div class="row">
                      <div class="col-sm-12 ">
                        <div class="">
                          <div class="row">
                            <!-- <div class="col-sm-12">
                              <a href="" data-toggle="modal" data-tt="tooltip" data-target="#add_service_modal" class="float-right"><?=$this->lang->line('scrap_issue_add_new_service')?></a>
                            </div> -->
                            <div class="col-sm-12">
                              <table class="table table-bordered" style="background-color:#FFFDD0">
                                <tr>
                                  <th>Total Taxable Value  :  <span class="total_taxable_value"><?=$scrap_issue->total_taxable_value?></span></th>
                                  <th>Total Tax  :  <span class="total_tax"><?=$scrap_issue->total_tax?></span></th>
                                  <th>Total Amount  :  <span class="total"><?=$scrap_issue->total?></span></th>
                                </tr>
                              </table>
                            </div>
                          </div>
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label><?=$this->lang->line('scrap_issue_items')?></label>
                                  ...
                                  <tr class="product_row">
                                    <td>
                                      ...
                                      <?php 
                                        ...
                                        $cost         = $row->cost;
                                        $warehouse_id = $scrap_issue->warehouse_id;
                          ...
                          <table class="table table-striped table-bordered table-condensed table-hover total_data d-none" style="font-size: 18px;">
                            <tr>
                              <td align="right"  width="66%"> <?=$this->lang->line('scrap_issue_total_discount')?>(<?=$currency?>)</td>
                              <td align='right' class="text-danger"  width="34%">
                                -<span id="total_discount"><?=$scrap_issue->total_discount?></span>
                                <input type="hidden" name="total_discount" id="t_discount" value="<?=$scrap_issue->total_discount?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('scrap_issue_total_taxable_value')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                +<span id="total_taxable_value"><?=$scrap_issue->total_taxable_value?></span>
                                <input type="hidden" name="total_taxable_value" id="t_taxable_value" value="<?=$scrap_issue->total_taxable_value-$scrap_issue->tds?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('scrap_issue_total_tax')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                +<span id="total_tax"><?=$scrap_issue->total_tax?></span>
                                <input type="hidden" name="total_tax" id="t_tax" value="<?=$scrap_issue->total_tax?>">
                              </td>
                            </tr>
                            <tr>
                              <td align="right" width="66%"><?=$this->lang->line('tds')?>(<?=$currency?>)</td>
                              <td align='right' class="text-success" width="34%">
                                <input type="number" class="form-control" name="tds" id="tds" value="<?=$scrap_issue->tds?>" style="text-align: right">
                              </td>
                            </tr>
                            <tr>
                              <td align="right"  width="66%"><?=$this->lang->line('scrap_issue_total')?>(<?=$currency?>)</td>
                              <td align='right' width="34%">
                                <span id="total"><?=$scrap_issue->total?></span>
                                <input type="hidden" name="total" id="t" value="<?=$scrap_issue->total?>">
                              </td>
                            </tr>
                          </table>
                          ...
                          <div class="controls">
                            <div class="tabbable">
                              <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                                <li class="nav-item">
                                  <a class="nav-link active" href="#external_note" data-toggle="pill"><?php echo $this->lang->line('scrap_issue_external_note'); ?></a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="#internal_note" data-toggle="pill"><?php echo $this->lang->line('scrap_issue_internal_note'); ?></a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="#bank_detail" data-toggle="pill"><?php echo $this->lang->line('scrap_issue_bank_detail'); ?></a>
                                </li>
                                <li class="nav-item">
                                  <a class="nav-link" href="#terms_and_condition" data-toggle="pill"><?php echo $this->lang->line('scrap_issue_terms_and_condition'); ?></a>
                                </li>
                              </ul>                           
                              <br>
                              <div class="tab-content">
                                <div class="tab-pane active" id="external_note">
                                  <textarea class="col-sm-12 form-control" name="external_note" rows="4" placeholder="<?php echo $this->lang->line('scrap_issue_external_note'); ?>"><?=str_replace("<br />","",$scrap_issue->external_note)?></textarea>
                                </div>
                                <div class="tab-pane" id="internal_note">
                                  <textarea class="col-sm-12 form-control" name="internal_note" rows="4" placeholder="<?php echo $this->lang->line('scrap_issue_internal_note'); ?>"><?=str_replace("<br />","",$scrap_issue->internal_note)?></textarea>
                                </div>
                                <div class="tab-pane" id="bank_detail">
                                  <textarea class="col-sm-12 form-control" name="bank_detail" rows="4" placeholder="<?php echo $this->lang->line('scrap_issue_bank_detail'); ?>"><?=str_replace("<br />","",$scrap_issue->bank_detail)?></textarea>
                                </div>
                                <div class="tab-pane" id="terms_and_condition">
                                  <textarea class="col-sm-12 form-control" name="terms_and_condition" rows="4" placeholder="<?php echo $this->lang->line('scrap_issue_terms_and_condition'); ?>"><?=str_replace("<br />","",$scrap_issue->terms_and_condition)?></textarea>
                                </div>
                              </div>
                            </div>   
                          </div>
                ...
                <div class="card-footer">
                 <input type="hidden" name="rcm" id="rcm" value="<?=$scrap_issue->rcm?>">
                  <input type="hidden" name="id" value="<?=$scrap_issue->id?>">
                  <input type="hidden" name="scrap_issue_items" id="scrap_issue_items" value="">
                  ...
                  <!-- <button type="submit" name="submit" id="ScrapissueSubmit" class="btn btn-info"><?=$this->lang->line('scrap_issue_add')?></button> -->
                  <!-- <button type="submit" name="submit" id="ScrapissueSubmitPayNow" value="pay" name="pay" class="btn btn-info">Add Sale & Pay Now</button>                      -->
                  <span class="btn btn-default float-right" id="cancel" onclick="cancel('sale')"><?=$this->lang->line('scrap_issue_cancel')?></span>
                </div>
            </form>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header warning-header">
        <h5 class="modal-title" id="exampleModalLabel"> <?=$this->lang->line('scrap_issue_message_label')?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <?=$this->lang->line('empty_scrap_issue_warning_label')?>
      </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function(e){
    ...
    const scrapissueToast = Swal.mixin({
                        toast: true,
                        position: 'top-end',
      ...
      $('#supplier_id').change(function(e){
        ...
        if(supplier_id != '')
        {
          ...
          $('#supplier_state_id').val(state_id);
          $('#supplier_country_id').val(country_id);
      ...
      $(function(){
        $('#search_product').autoComplete({
          ...
          source: function(term, suggest){
            ...
            $.ajax({
              url: "<?php echo base_url('scrap_product/search') ?>",
              type: "POST",
              dataType: "json",
              data:{
                'term': term,
                // 'warehouse_id': warehouse_id,
                'module': '<?=SCRAP_ISSUE_MODULE?>',
                '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'
              },
              success: function(data){
                var products = data;
          ...
          onSelect: function(event, ui) {
            ...
            $.ajax({
              url: "<?php echo base_url('scrap_product/get_record_detail') ?>",
              type: "POST",
              dataType: "json",
              data:{
                'id': id, // here product is warehouse_product_id 
                'module': '<?=SCRAP_ISSUE_MODULE?>',
      ...
      function add_row(product,discounts)
      {
        ...
        input_quantity  +=  '<input type="number" class="form-control" name="quantity" value="1" step="0.01" max="'+(product.quantity)+'" min="0.01" readonly>';
        ...
        var newRow = $('<tr class="service_row">');
            ...
            cols += '<td>'
                      ...
                      + '<input type="hidden" name="warehouse_product_id" value="'+product.warehouse_product_id+'">'  
                    +'</td>';
            cols += '<td>'
      ...
      function is_product_exist_in_row(id)
      { 
        ...
        $("#product_table_body").find('tr').each(function () {
          ...
          if(tr.find('input[name="id"]').val() == id)
          {
            isProductExist = true;
          }
        });
      ...
      //   // console.log('supplier_id : '+promotions[0].supplier_id);
      ...
      //   globalRules = promotions.find(promo => promo.product_id === '0' && promo.supplier_id === '0');
      ...
      //   productRules = promotions.find(promo => (promo.product_id === productId || promo.product_id === '0') && promo.supplier_id === supplierId);
      //   if (productRules) {
      ...
      $('#editScrapissueForm').submit(function(e){
        // e.preventDefault();

        var isError = false;
        $('#ScrapissueSubmit').text('<?=$this->lang->line("please_wait")?>').attr('disabled','disabled');

        $('form#editScrapissueForm .field_validation').each(function() {
          var id    = $(this).attr('id');
          var value = $(this).val();
          var field = $(this).attr('placeholder');

          if(value==null || value==""){
            $("form#editScrapissueForm #err_"+id).text(field+ " field is required.").fadeIn('slow');
            $('form#editScrapissueForm #'+id).addClass('is-invalid');
            isError = true;
          }
          else
          {
            $("form#editScrapissueForm #err_"+id).text("").fadeOut('slow');
            $('form#editScrapissueForm #'+id).removeClass('is-invalid');
            $('form#editScrapissueForm #'+id).addClass('is-valid');
          }
        });
        ...
        {
          $('#scrap_issue_items').val(productDataArray.join('|'));
        }
        else
        {
          isError = true;
        ...
        if (hasZeroCost) {
            isError = true;
            $('#ScrapissueSubmit').text('<?=$this->lang->line("scrap_issue_add")?>').removeAttr('disabled');
            return false;
      ...
      $("form#editScrapissueForm .field_validation").on("blur keyup change",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
      ...
      function autosaveForm()
      {
        ...
        if((supplier_id != '') && ($('#product_table_body').find('tr').length > 0))
        {
          ...
          var packslipFormData       = $('#editScrapissueForm').serialize();
          ...
          if(!isError)
          {
            $.ajax({
              async:false,
              url: "<?php echo base_url('scrap_issue/edit')?>",
              type: "POST",
      ...
      $('.rcm_btn').click(function(e){
        ...
        {
          $('.rcm-confirmation-body').html('<?=$this->lang->line('scrap_issue_rcm_confirmation_message')?>');
          ...
          $('#rcm-confirmation').modal({
              ...
              {
                $('#rcm').val('1');
                $('.rcm_btn').text('<?=$this->lang->line('scrap_issue_disable_rcm')?>');
              }
              else
              {
                $('#rcm').val('0');
                $('.rcm_btn').text('<?=$this->lang->line('scrap_issue_enable_rcm')?>');
              }
