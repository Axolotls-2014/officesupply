...
<html>
  ...
  <body>
      ...
      <center>
        <h3>
          <?=$this->lang->line('header_scrap_receive')?> (<?=$scrap_receive->reference_no?>)
        </h3>
      </center>
      <h3 style="float: right">
        <?=$this->lang->line('date')?>: <?=date('d-m-Y', strtotime($scrap_receive->scrap_receive_date))?>
      </h3>
      <br/><br/>                     
      <table style="width:100%">
        <tr>
          <th style="width: 25%;"></th>
          <th style="width: 25%;"><?=$this->lang->line('company_detail')?></th>
        ...
        <tr>
          ...
          <td>
            ...
            <strong><?=$this->lang->line('gstin_of_customer')?>: <?=$company_setting->gstin?></strong><br>
          </td>
      ...
      <table style="width: 100%;">
        <tr class="table_header">
          <td colspan="5" style="font-weight: bolder;"><?=$this->lang->line('terms_condition')?></td>
