      ...
      <div class="row mb-2">
        <div class="col-sm-12">
          <ol class="breadcrumb breadcrumb-custom float-sm-left">
            ...
            <li class="breadcrumb-item"><a href="<?=base_url('auth/dashboard')?>"><?=$this->lang->line('home')?></a></li>
              ...
              <table id="example" class="table table-bordered table-striped">
                <thead>
                  <tr>
                    ...
                    <th><?=$this->lang->line('customer_company_name')?></th>
                ...
                <tbody>
                  ...
                  <tr>                        
                    ...
                    <td><?php echo $value->customer_company_name;?></td>
                    ...
                    <td>
                      <table>
                        <tr>
                          ...
                          ?>
                          <td class="p-2">
                            <a href="<?php echo base_url('customer/view/'.base64_encode($value->id));?>" class="btn btn-default btn-xs">
                          ...
                          ?>
                          <td class="p-2">
                            <a href="<?php echo base_url('customer/edit/'.base64_encode($value->id));?>" class="btn btn-info btn-xs" data-tt="tooltip" title="">
                          ...
                          ?>
                          <td class="p-2">
                            <a href="#"  data-toggle="modal" data-target="#delete_customer_<?php echo base64_encode($value->id);?>" data-tt="tooltip" title="Delete" class="btn btn-danger btn-xs delete_product">
                              <i class="fas fa-trash"></i>
                            </a>

                            <?php 
                              $sales        = $this->sale_model->get_sale_records_by_customer_id(base64_encode($value->id));
                              $quotations   = $this->quotation_model->get_quotation_records_by_customer_id(base64_encode($value->id));

                              if(sizeof($sales) > 0 || sizeof($quotations) > 0)
                              {
                            ?>
                                <div class="example-modal">
                                  <div class="modal fade" id="delete_customer_<?php echo base64_encode($value->id);?>">
                                      ...
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                          ...
                                          <form action="<?php echo base_url('customer/delete');?>" method="POST">
                                            <input type="hidden" name="id" value="<?=base64_encode($value->id)?>">
