...
<div class="wrapper">
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <form class="form-horizontal" method="post" action="<?php base_url('customer/edit')?>" id="customerForm">
                  ...
                  <tr>
                    <td style="width: 30%;">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="customer_company_name" value="<?=set_value('customer_company_name', $customer->customer_company_name) ?>" class="form-control form-control-sm field_validation" id="customer_company_name" placeholder="<?=$this->lang->line('customer_company_name')?>" required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="customer_name" value="<?=set_value('customer_name', $customer->customer_name) ?>" class="form-control form-control-sm field_validation" id="customer_name" placeholder="<?=$this->lang->line('customer_name')?>" required>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="gstin" value="<?=set_value('gstin', $customer->gstin) ?>" class="form-control form-control-sm" id="gstin" placeholder="gstin">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="customer_department" value="<?=set_value('customer_department', $customer->customer_department) ?>" class="form-control form-control-sm" id="customer_department" placeholder="<?=$this->lang->line('customer_department')?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="email" value="<?=set_value('email', $customer->email) ?>" class="form-control form-control-sm" id="email" placeholder="<?=$this->lang->line('customer_email')?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="phone" value="<?=set_value('phone', $customer->phone) ?>" class="form-control form-control-sm" id="phone" placeholder="<?=$this->lang->line('customer_phone')?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="password" value="<?=set_value('password', $customer->password) ?>" class="form-control form-control-sm" id="password" placeholder="password" step="any">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control form-control-sm select2bs4" name="payment_duration" id="payment_duration" width="100%">
                            <?php for ($i = 1; $i <= 180; $i++) { ?>
                              <option value="<?=$i;?>" <?=($i == $customer->payment_duration) ? 'selected' : ''?>><?=$i .' days';?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
    ...
    <select class="form-control form-control-sm"
      ...
      <?php foreach($due_days_options as $option): ?>
        <option value="<?= $option->due_day ?>"
          ...
          <?= ($customer->default_due_days == $option->due_day) ? 'selected' : '' ?>>
          <?= $option->due_day ?> Days
        </option>
      <?php endforeach; ?>
...
<div class="form-group row">
  ...
  <div class="col-sm-8">
    ...
    <textarea class="form-control form-control-sm"
              ...
              rows="3"><?= set_value('default_payment_terms', $customer->default_payment_terms) ?></textarea>
                          ...
                          <select class="form-control form-control-sm select2bs4 field_validation" name="whatsapp_country_code" id="whatsapp_country_code" width="100%">
                            ...
                            ?>
                              <option value="<?=$value->phonecode;?>"
                                <?php 
                                  if($customer->whatsapp_country_code == $value->phonecode)
                                    echo ' selected';
                                ?>
                              >
                    ...
                    <td style="width: 30%;">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control form-control-sm select2bs4 field_validation" name="country_id" id="country_id" width="100%">
                            ...
                            <?php
                              ...
                              foreach ($countries as $value) {
                            ?>
                              <option value="<?=$value->id;?>" <?php echo set_select('country_id', $value->id, $customer->country_id == $value->id); ?>>
                                <?= $value->name;?>
                              </option>
                            <?php } ?>
                          </select>
                          ...
                          <select class="form-control form-control-sm select2bs4 field_validation" name="state_id" id="state_id" width="100%">
                            ...
                            <?php if(isset($states)) {
                              ...
                              foreach ($states as $value) { ?>
                                <option value="<?=$value->id;?>" <?php echo set_select('state_id', $value->id, $customer->state_id == $value->id); ?>>
                                  <?= $value->name;?>
                                </option>
                              <?php }
                            } ?>
                          ...
                          <select class="form-control form-control-sm select2bs4" name="city_id" id="city_id" width="100%">
                            ...
                            <?php if(isset($cities)) {
                              foreach ($cities as $value) { ?>
                                <option value="<?=$value->id;?>" <?php echo set_select('city_id', $value->id, $customer->city_id == $value->id); ?>>
                                  <?= $value->name;?>
                                </option>
                              <?php }
                            } ?>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="address" value="<?=set_value('address', $customer->address) ?>" class="form-control form-control-sm" id="address" placeholder="<?=$this->lang->line('customer_address')?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                          <input type="text" name="pincode" value="<?=set_value('pincode', $customer->pincode) ?>" class="form-control form-control-sm" id="pincode" placeholder="<?=$this->lang->line('customer_pincode')?>">
                      ...
                      <div id="shipping_addresses_container">
                        <?php if(!empty($shipping_addresses)): ?>
                          <?php foreach($shipping_addresses as $index => $address): ?>
                            <div class="shipping-address-group" data-index="<?=$index?>">
                              <div class="form-group row">
                                <label class="col-sm-4 col-form-label">Address Name</label>
                                <div class="col-sm-8">
                                  <input type="text" name="shipping_address[<?=$index?>][shipping_name]" value="<?=$address->shipping_name?>" class="form-control form-control-sm" placeholder="e.g. Main Office, Warehouse">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <select class="form-control form-control-sm select2bs4 shipping_country" name="shipping_address[<?=$index?>][shipping_country_id]" width="100%">
                                    <option value="">Select Country</option>
                                    <?php foreach ($countries as $value): ?>
                                    <option value="<?=$value->id?>" <?=($value->id == $address->shipping_country_id) ? 'selected' : ''?>>
                                      <?=$value->name?>
                                    </option>
                                    <?php endforeach; ?>
                                  </select>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <select class="form-control form-control-sm select2bs4 shipping_state" name="shipping_address[<?=$index?>][shipping_state_id]" width="100%">
                                    <option value="">Select State</option>
                                    <?php if(isset($states)): ?>
                                      <?php foreach ($states as $value): ?>
                                      <option value="<?=$value->id?>" <?=($value->id == $address->shipping_state_id) ? 'selected' : ''?>>
                                        <?=$value->name?>
                                      </option>
                                      <?php endforeach; ?>
                                    <?php endif; ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <select class="form-control form-control-sm select2bs4 shipping_city" name="shipping_address[<?=$index?>][shipping_city_id]" width="100%">
                                    <option value="">Select City</option>
                                    <?php if(isset($cities)): ?>
                                      <?php foreach ($cities as $value): ?>
                                      <option value="<?=$value->id?>" <?=($value->id == $address->shipping_city_id) ? 'selected' : ''?>>
                                        <?=$value->name?>
                                      </option>
                                      <?php endforeach; ?>
                                    <?php endif; ?>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <textarea name="shipping_address[<?=$index?>][shipping_address]" class="form-control form-control-sm" rows="2"><?=$address->shipping_address?></textarea>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <input type="text" name="shipping_address[<?=$index?>][shipping_pincode]" value="<?=$address->shipping_pincode?>" class="form-control form-control-sm">
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                <div class="col-sm-8 offset-sm-4">
                                  <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="shipping_address[<?=$index?>][is_default]" value="1" <?=($address->is_default == 1) ? 'checked' : ''?>>
                              ...
                              <div class="form-group row">
                                <div class="col-sm-12 text-right">
                                  <input type="hidden" name="shipping_address[<?=$index?>][id]" value="<?=$address->id?>">
                                  <button type="button" class="btn btn-danger btn-sm remove-shipping-address" <?=($index == 0) ? 'style="display: none;"' : ''?>>Remove</button>
                                </div>
                              </div>
                            </div>
                          <?php endforeach; ?>
                        <?php else: ?>
                          <!-- Default empty shipping address if none exists -->
                          <div class="shipping-address-group" data-index="0">
                            ...
                            <div class="form-group row">
                              <div class="col-sm-8 offset-sm-4">
                                <div class="form-check">
                                  <input class="form-check-input" type="checkbox" name="shipping_address[0][is_default]" value="1" checked>
                                  <label class="form-check-label">Set as Default Shipping Address</label>
                                </div>
                              </div>
                            </div>
...
// ⭐ TRIGGER ON PAGE LOAD (FOR EDIT PAGE PREFILL)

$('#default_due_days').trigger('change');

  // Initialize Select2 on all existing groups
  $('.shipping-address-group').each(function() {
    initSelect2($(this));
  });
  ...
  $('#add_shipping_address').click(function() {
    ...
    newGroup.find('input[name*="[id]"]').remove(); // Remove any hidden ID fields
  ...
  $(document).on('click', '.remove-shipping-address', function() {
    if($('.shipping-address-group').length > 1) {
      ...
      $('#shipping_addresses_container .shipping-address-group').each(function(index) {
        ...
        if(index === 0) {
          $(this).find('.remove-shipping-address').hide();
        }
      });
    }
  });
