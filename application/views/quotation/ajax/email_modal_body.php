<form method="POST" action="<?php echo base_url('test/send_email')?>" name="sendEmailForm" id="sendEmailForm">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <?php 
                ...
                $replace = array($quotation->reference_no, $customer->customer_name);
                $subject = $email_template ? str_replace($search, $replace, $email_template->subject) : $quotation->reference_no;
              ?>

              <input type="text" name="subject" value="<?= ($email_template && $email_template->subject) ? $subject : $quotation->reference_no ?>"  class="form-control form-control-sm field_validation" id="subject" placeholder="Subject">
