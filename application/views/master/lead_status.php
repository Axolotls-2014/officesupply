      ...
      <div class="row mb-2">
        <div class="col-sm-12">
          <ol class="breadcrumb breadcrumb-custom float-sm-left">
            ...
            <li class="breadcrumb-item "><a href="<?= base_url('Masters/add') ?>">Add Status</a></li>
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              <div class="card-tools">
                <button type="button" class="btn btn-block btn-primary btn-sm add_source_modal" data-toggle="modal" data-target="#add_source_modal" data-tt="tooltip" title="Click here to Add Source">Add Lead Status</button>
              </div>
              ...
              <table id="example" class="table table-bordered table-striped">
               ...
               <tbody>
                  <?php if (!empty($status)): ?>
                    ...
                    <?php foreach ($status as $source): ?>
                      <tr> 
                        <td><?= $i++; ?></td>
                        <td><?= htmlspecialchars($source->name); ?></td>
                        <td><?= htmlspecialchars($source->isdefault); ?></td>
                        <td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          ...
          <form id="addSourceForm"  action="<?= base_url('Masters/add_lead_status') ?>" method="POST">
...
<div class="modal fade" id="edit_source_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form id="editSourceForm" action="<?= base_url('Masters/lead_edit') ?> "  method="POST">
         <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
        <div class="modal-body">
...
<div class="modal fade" id="delete_source_modal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
          <form id="deleteSourceForm" action="<?= base_url('Masters/lead_delete') ?> "  method="POST">
         <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
