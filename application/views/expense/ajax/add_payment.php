<div class="form-group row">
  ...
  <div class="col-sm-4">
    <input type="text" name="voucher_date" value="<?=date('d-m-Y')?>" class="form-control form-control-sm datepicker" id="voucher_date" placeholder="<?=$this->lang->line('voucher_date')?>">
  </div>
</div>

<div class="form-group row">
  <label for="inputEmail3" class="col-sm-2 col-form-label">
    <?=$this->lang->line('from_account')?>
    <span class="text-danger">*</span>
  </label>
  <div class="col-sm-4">
    <select class="form-control form-control-sm select2bs4 field_validation" name="from_account" id="from_account" placeholder="<?=$this->lang->line('from_account')?>" width="100%">
      <option value=""><?=$this->lang->line('select')?></option>
      <?php
        foreach ($from_account as $value) {
      ?>
        <option value="<?=$value->id;?>" data-title="<?=ucfirst($value->title)?>" data-closing_balance="<?=$value->closing_balance?>">
...
<div class="form-group row">
  ...
  <div class="col-sm-4">
    <input type="number" name="transaction_amount" value="<?=$expense->total_amount-$paid_amount?>" class="form-control form-control-sm field_validation" id="transaction_amount" placeholder="<?=$this->lang->line('transaction_amount')?>" max="<?=$expense->total_amount-$paid_amount?>">
