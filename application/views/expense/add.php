                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="date" class="form-control form-control-sm field_validation datepicker" id="date" placeholder="<?=$this->lang->line('expense_date')?>" value="<?=date('d-m-Y')?>">
                        ...
                        <div class="form-group row d-none">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="supplier_name" id="supplier_name" placeholder="<?=$this->lang->line('expense_supplier_name')?>" width="100%">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="amount" value="<?=set_value('amount',0) ?>" class="form-control form-control-sm field_validation" id="amount" placeholder="<?=$this->lang->line('expense_amount')?>" readonly="readonly">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="cgst" value="<?=set_value('cgst',0.0)?>" class="form-control form-control-sm field_validation" id="cgst" placeholder="<?=$this->lang->line('expense_cgst')?>" step="0.01" readonly="readonly">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="sgst" value="<?=set_value('sgst',0.0)?>" class="form-control form-control-sm field_validation" id="sgst" placeholder="<?=$this->lang->line('expense_sgst')?>"  step="0.01"  readonly="readonly">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="igst" value="<?=set_value('igst',0.0)?>" class="form-control form-control-sm field_validation" id="igst" placeholder="<?=$this->lang->line('expense_igst')?>" step="0.01"  readonly="readonly">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="total_amount" value="<?=set_value('total_amount',0) ?>" class="form-control form-control-sm field_validation" id="total_amount" placeholder="<?=$this->lang->line('expense_total_amount')?>"  step="0.01" readonly>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="remarks" value="" class="form-control form-control-sm" id="remarks" placeholder="<?=$this->lang->line('expense_remarks')?>">
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12">
                            <table class="table table-bordered d-none item_table" width="100%">
                              <thead>
                                <tr>
                                  <th width="25%">Item</th>
        ...
        $.ajax({
          ...
          success: function(response){
            ...
            { 
              ...
              if($('form#addExpenseForm #expense_item_id').length)
              {
                $('form#addExpenseForm #expense_item_id').html('');
                $('form#addExpenseForm #expense_item_id').append('<option value="">Select</option>');
                
                for(i=0;i<response['items'].length;i++)
                { 
                  $('form#addExpenseForm #expense_item_id').append('<option value="' + response['items'][i].id + '" data-igst="'+response['items'][i].igst+'" data-cgst="'+response['items'][i].cgst+'" data-sgst="'+response['items'][i].sgst+'">' + response['items'][i].item_name +'</option>');
                }

                $('form#addExpenseForm #expense_item_id').val(response['id']).attr("selected","selected");
        ...
        url: "<?php echo base_url('expense_category/add')?>",
          ...
          success: function(response){
            ...
            $('#add_expense_category_modal').modal('hide');
              ...
              if($('form#addExpenseForm #expense_category_id').length)
              {
                $('form#addExpenseForm #expense_category_id').html('');
                $('form#addExpenseForm #expense_category_id').append('<option value="">Select</option>');
                
                for(i=0;i<response['expense_categories'].length;i++)
                { 
                  $('form#addExpenseForm #expense_category_id').append('<option value="' + response['expense_categories'][i].id + '">' + response['expense_categories'][i].name +'</option>');
                }

                $('form#addExpenseForm #expense_category_id').val(response['id']).attr("selected","selected");
...
<script type="text/javascript">
  ...
  //   $("#cgst, #sgst, #igst, #amount").on("keydown keyup", calculate_total_expense_amount);
...
<script type="text/javascript">
  $(document).ready(function(e){
    ...
    $('form#addExpenseForm').submit(function(e){
      // e.preventDefault();
      ...
      $('form#addExpenseForm .field_validation').each(function() {
          ...
          if(value==null || value==""){
            $("form#addExpenseForm #err_"+id).text(field+ " field is required.").fadeIn('slow');
            $('form#addExpenseForm #'+id).addClass('is-invalid');
            $('form#addExpenseForm #'+id).removeClass('is-valid');
            isError = true;
          }
          else
          {
            $("form#addExpenseForm #err_"+id).text("").fadeOut('slow');
      ...
      else 
      {
        ...
        $("#item_table_body").find('tr').each(function () {
            ...
            itemData['igst']                   = tr.find('input[name="igst_rate"]').val();
            itemData['igst_tax']               = tr.find('span[name="igst_amount"]').text();
            itemData['sgst']                   = tr.find('input[name="sgst_rate"]').val();
            itemData['sgst_tax']               = tr.find('span[name="sgst_amount"]').text();
            itemData['cgst']                   = tr.find('input[name="cgst_rate"]').val();
    ...
    $("form#addExpenseForm .field_validation").on("blur change keyup",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
