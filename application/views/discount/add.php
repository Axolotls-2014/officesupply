  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item active"><?=$this->lang->line('discount_add')?></li>
              </ol>
            </div>
          </div>
      </section>
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-12">
            <form class="form-horizontal" name="addDiscountForm" id="addDiscountForm" method="post" action="">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('discount_add')?></h3>
                </div>
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" name="name" value="<?=set_value('name') ?>" class="form-control form-control-sm field_validation" id="name" placeholder="<?=$this->lang->line('discount_name')?>"><?=form_error('name', '<div class="text-danger">', '</div>');?>
                  ...
                  <div class="form-group row">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="value" value="<?=set_value('value') ?>" class="form-control form-control-sm field_validation" id="value" placeholder="<?=$this->lang->line('discount_value')?>"><?=form_error('value', '<div class="text-danger">', '</div>');?>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-control-sm float-right field_validation" name="valid_from" id="valid_from" placeholder="<?=$this->lang->line('discount_valid_from')?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control form-control-sm float-right field_validation" name="valid_to" id="valid_to" placeholder="<?=$this->lang->line('discount_valid_to')?>" data-inputmask-alias="datetime" data-inputmask-inputformat="dd-mm-yyyy" data-mask><?=form_error('valid_to', '<div class="text-danger">', '</div>');?>
                ...
                <div class="card-footer">
                  ...
                  <button type="submit" name="submit" id="discountSubmit" class="btn btn-info"><?=$this->lang->line('discount_save')?></button>
...
<script type="text/javascript">
  ...
  $(document).ready(function(e){
    ...
    $('form#addDiscountForm').submit(function(e){
      // e.preventDefault();
      ...
      if(isError == true)
      {
        $('#discountSubmit').text('<?=$this->lang->line("discount_save")?>').removeAttr('disabled');
        return false;
      }  
      else 
      {
    ...
    $("form#addDiscountForm .field_validation").on("blur keyup",  function (event){
        var id    = $(this).attr('id');
        var value = $(this).val();
        var field = $(this).attr('placeholder');
...
<script>
  $(document).ready(function(e){
    // $('#discount_valid_from').inputmask('mm/dd/yyyy', { 'placeholder': 'mm/dd/yyyy' })
    $('[data-mask]').inputmask();
  });
</script>
