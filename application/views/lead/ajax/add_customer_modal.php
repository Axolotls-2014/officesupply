        ...
        <form role="form" method="post" name="addCustomerForm" id="addCustomerForm">
          ...
          <div class="modal-body">
            ...
            <table style="width: 100%;">
              <!-- <tr>
                <th style="text-align: left;background-color: #F5F5F5;font-style: normal;" class="d-none">Personal Details</th>
                <th style="text-align: left;background-color: #F5F5F5;font-style: normal;" class="d-none">Billing Details</th>
                <th style="text-align: left;background-color: #F5F5F5;font-style: normal;" class="d-none">Shipping Details ( <input type="checkbox" id="copy_address" name="copy_address"> same as billing details)</th>
              </tr> -->
              <tr>
                <td style="width: 100%;">
                  ...
                  <div class="form-group row d-none">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">
                      <?=$this->lang->line('customer_margin')?>
                    </label>
                    <div class="col-sm-8">
                      <input type="number" name="margin" value="<?=set_value('margin') ?>" class="form-control form-control-sm" id="margin" placeholder="<?=$this->lang->line('customer_margin')?>" step="any">
                      <span id="err_margin" class="error invalid-feedback"><?=form_error('margin');?></span>
                    </div>
                  </div>
                  <div class="form-group row d-none">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">
