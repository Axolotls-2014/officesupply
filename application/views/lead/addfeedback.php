<?php $this->load->view('layout/header');?>
  ...
  <div class="wrapper">
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            <div class="col-sm-12">
              <ol class="breadcrumb breadcrumb-custom float-sm-left">
                ...
                <li class="breadcrumb-item "><a href="<?=base_url('lead')?>"><?=$this->lang->line('header_feedback')?></a></li>
                <li class="breadcrumb-item active"><?=$this->lang->line('add_feedback')?></li>
              </ol>
            </div>
          </div>
      </section>
            ...
            <form class="form-horizontal" name="addCustomerForm" id="addCustomerForm" method="post" action="">
              <div class="card card-info">
                <div class="card-header">
                  <h3 class="card-title"><?=$this->lang->line('add_feedback')?></h3>
      ...
      <div class="form-group row">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="name" value="<?=set_value('name') ?>" class="form-control form-control-sm field_validation" id="name" placeholder="<?=$this->lang->line('name')?>">
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="address" value="<?=set_value('address') ?>" class="form-control form-control-sm" id="address" placeholder="<?=$this->lang->line('address')?>">
                          ...
                          <div class="col-sm-8">
                            <input type="number" name="phone_no" value="<?=set_value('phone_no') ?>" class="form-control form-control-sm" id="phone_no" placeholder="<?=$this->lang->line('phone_no')?>">
                          ...
                          <div class="col-sm-8">
                            <input type="date" name="visit_date" value="<?=set_value('visit_date') ?>" class="form-control form-control-sm" id="visit_date" placeholder="<?=$this->lang->line('visit_date')?>">
                            <span id="err_visit_date" class="error invalid-feedback"><?=form_error('visit_date');?></span>
                          ...
                          <div class="col-sm-8">
                            <input type="text" name="reference" value="<?=set_value('reference') ?>" class="form-control form-control-sm" id="reference" placeholder="<?=$this->lang->line('reference')?>">
  ...
  <div class="col-sm-8">
    <textarea name="request" class="form-control form-control-sm" id="request" placeholder="request"><?=set_value('request') ?></textarea>
  ...
  <div class="col-sm-8">
    <textarea name="note" class="form-control form-control-sm mt-2" id="note" placeholder="Note"><?=set_value('note') ?></textarea>
...
<div class="col-md-8 mt-2">
  <select class="form-control field_validation form-control-sm select2bs4" style="width: 100%;" placeholder="<?=$this->lang->line('salesman_name')?>" id="salesman" name="salesman[]" multiple="multiple">
    <option value="">Select</option>
    <?php
        foreach ($employees as $value) {
            $selected = (in_array($value->employee_id, set_value('salesman', []))) ? 'selected' : '';
    ?>
 ...
 <label for="employee_id" class="col-md-4 required"><?=$this->lang->line('receptionist')?></label>
        <div class="col-md-8 mt-2">
          <select class="form-control field_validation form-control-sm select2bs4  mt-2" style="width: 100%;" placeholder="<?=$this->lang->line('receptionist')?>" id="receptionist" name="receptionist">
            <option value="">Select</option>
            <?php
                foreach ($employees as $value) {
          ...
          <span id="err_receptionist" class="error invalid-feedback"></span> 
        </div>
      </div>
                ...
                <div class="card-footer">
                  ...
                  <a href="<?=base_url('lead/feedback_list')?>" class="btn btn-default float-right"><?=$this->lang->line('lead_cancel')?></a>
                </div>
              </div>
            </form>
          </div>
