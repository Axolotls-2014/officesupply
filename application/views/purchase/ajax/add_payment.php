  ...
  <div class="col-sm-4">
    <select class="form-control form-control-sm select2bs4 field_validation" name="from_account" id="from_account" placeholder="<?=$this->lang->line('from_account')?>" width="100%">
      ...
      <?php
        ...
        {
          if($value->active == ACCOUNT_STATUS_ACTIVE){
      ?>
...
<div class="form-group row">
  ...
  <div class="col-sm-4">
    <input type="number" name="transaction_amount" value="<?=$purchase->total-$paid_amount?>" class="form-control form-control-sm field_validation" id="transaction_amount" placeholder="<?=$this->lang->line('transaction_amount')?>" max="<?=$purchase->total-$paid_amount?>">
